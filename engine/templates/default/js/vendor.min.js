! function(t) {
    ...
    e = function() {
        ...
        var s, o, n, r = this,
            a = t(e.currentTarget);
        switch (a.is("a") && e.preventDefault(), a.is("li") || (a = a.closest("li")), n = r.slideCount % r.options.slidesToScroll !== 0, s = n ? 0 : (r.slideCount - r.currentSlide) % r.options.slidesToScroll, e.data.message) {
            case "previous":
        ...
        var e, i, s, o, n, r = this,
            a = !1;
        if ("object" === t.type(arguments[0]) ? (s = arguments[0], a = arguments[1], n = "multiple") : "string" === t.type(arguments[0]) && (s = arguments[0], o = arguments[1], a = arguments[2], "responsive" === arguments[0] && "array" === t.type(arguments[1]) ? n = "responsive" : "undefined" != typeof arguments[1] && (n = "single")), "single" === n) r.options[s] = o;
        ...
        var e, i, s, o, n = this;
        i = n.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), n.$slides.eq(t).addClass("slick-current"), n.options.centerMode === !0 ? (e = Math.floor(n.options.slidesToShow / 2), n.options.infinite === !0 && (t >= e && t <= n.slideCount - 1 - e ? n.$slides.slice(t - e, t + e + 1).addClass("slick-active").attr("aria-hidden", "false") : (s = n.options.slidesToShow + t,
            i.slice(s - e + 1, s + e + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === t ? i.eq(i.length - 1 - n.options.slidesToShow).addClass("slick-center") : t === n.slideCount - 1 && i.eq(n.options.slidesToShow).addClass("slick-center")), n.$slides.eq(t).addClass("slick-center")) : t >= 0 && t <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(t, t + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : i.length <= n.options.slidesToShow ? i.addClass("slick-active").attr("aria-hidden", "false") : (o = n.slideCount % n.options.slidesToShow, s = n.options.infinite === !0 ? n.options.slidesToShow + t : t, n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - t < n.options.slidesToShow ? i.slice(s - (n.options.slidesToShow - o), s + o).addClass("slick-active").attr("aria-hidden", "false") : i.slice(s, s + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")), "ondemand" === n.options.lazyLoad && n.lazyLoad()
            ...
            t.fn.perfectScrollbar = function(t) {
                return this.each(function() {
                    if ("object" == typeof t || "undefined" == typeof t) {
                        var e = t;
                        n.get(this) || o.initialize(this, e)
                    } else {
                        var i = t;
    ...
    2: [function(t, e, i) {
        ...
        i.add = function(t, e) {
            t.classList ? t.classList.add(e) : s(t, e)
    ...
    3: [function(t, e, i) {
        ...
        r.e = function(t, e) {
            ...
            return "object" == typeof e ? n(t, e) : "undefined" == typeof i ? s(t, e) : o(t, e, i)
    ...
    4: [function(t, e, i) {
        ...
        o.prototype.eventElement = function(t) {
            ...
            return "undefined" == typeof e && (e = new s(t), this.eventElements.push(e)), e
    ...
    6: [function(t, e, i) {
        ...
        i.extend = function(t, e) {
            ...
            for (var e = s.list(t), i = 0; i < e.length; i++) {
                var o = e[i];
                0 === o.indexOf("ps-") && s.remove(t, o)
            }
        }, i.outerWidth = function(t) {
            return n(o.css(t, "width")) + n(o.css(t, "paddingLeft")) + n(o.css(t, "paddingRight")) + n(o.css(t, "borderLeftWidth")) + n(o.css(t, "borderRightWidth"))
        }, i.startScrolling = function(t, e) {
            s.add(t, "ps-in-scrolling"), "undefined" != typeof e ? s.add(t, "ps-" + e) : (s.add(t, "ps-x"), s.add(t, "ps-y"))
        }, i.stopScrolling = function(t, e) {
            s.remove(t, "ps-in-scrolling"), "undefined" != typeof e ? s.remove(t, "ps-" + e) : (s.remove(t, "ps-x"), s.remove(t, "ps-y"))
        }, i.env = {
    ...
    9: [function(t, e, i) {
        ...
        e.exports = function(t) {
            var e = n.get(t);
            e && (e.event.unbindAll(), o.remove(e.scrollbarX), o.remove(e.scrollbarY), o.remove(e.scrollbarXRail), o.remove(e.scrollbarYRail), s.removePsClasses(t), n.remove(t))
        }
    }, {
        "../lib/dom": 3,
        "../lib/helper": 6,
    ...
    10: [function(t, e, i) {
        ...
        function s(t, e) {
            ...
            e.settings.stopPropagationOnClick && e.event.bind(e.scrollbarY, "click", s), e.event.bind(e.scrollbarYRail, "click", function(s) {
                var n = o.toInt(e.scrollbarYHeight / 2),
                    l = e.railYRatio * (s.pageY - window.pageYOffset - i(e.scrollbarYRail).top - n),
                    c = e.railYRatio * (e.railYHeight - e.scrollbarYHeight),
                    d = l / c;
                0 > d ? d = 0 : d > 1 && (d = 1), a(t, "top", (e.contentHeight - e.containerHeight) * d), r(t), s.stopPropagation()
            }), e.settings.stopPropagationOnClick && e.event.bind(e.scrollbarX, "click", s), e.event.bind(e.scrollbarXRail, "click", function(s) {
                var n = o.toInt(e.scrollbarXWidth / 2),
                    l = e.railXRatio * (s.pageX - window.pageXOffset - i(e.scrollbarXRail).left - n),
                    c = e.railXRatio * (e.railXWidth - e.scrollbarXWidth),
                    d = l / c;
                0 > d ? d = 0 : d > 1 && (d = 1), a(t, "left", (e.contentWidth - e.containerWidth) * d - e.negativeScrollAdjustment), r(t), s.stopPropagation()
            })
        }
        var o = t("../../lib/helper"),
            n = t("../instances"),
    ...
    11: [function(t, e, i) {
        ...
        function s(t, e) {
            function i(i) {
                ...
                var a = n.toInt(e.scrollbarXLeft * (e.contentWidth - e.containerWidth) / (e.containerWidth - e.railXRatio * e.scrollbarXWidth)) - e.negativeScrollAdjustment;
                c(t, "left", a)
            }
            var s = null,
                o = null,
                ...
                d = function() {
                    n.stopScrolling(t, "x"), e.event.unbind(e.ownerDocument, "mousemove", a)
                };
            e.event.bind(e.scrollbarX, "mousedown", function(i) {
                o = i.pageX, s = n.toInt(r.css(e.scrollbarX, "left")) * e.railXRatio, n.startScrolling(t, "x"), e.event.bind(e.ownerDocument, "mousemove", a), e.event.once(e.ownerDocument, "mouseup", d), i.stopPropagation(), i.preventDefault()
            })
        }

        function o(t, e) {
            function i(i) {
                var o = s + i * e.railYRatio,
                ...
                var a = n.toInt(e.scrollbarYTop * (e.contentHeight - e.containerHeight) / (e.containerHeight - e.railYRatio * e.scrollbarYHeight));
                c(t, "top", a)
            }
            var s = null,
                o = null,
                ...
                d = function() {
                    n.stopScrolling(t, "y"), e.event.unbind(e.ownerDocument, "mousemove", a)
                };
            e.event.bind(e.scrollbarY, "mousedown", function(i) {
                o = i.pageY, s = n.toInt(r.css(e.scrollbarY, "top")) * e.railYRatio, n.startScrolling(t, "y"), e.event.bind(e.ownerDocument, "mousemove", a), e.event.once(e.ownerDocument, "mouseup", d), i.stopPropagation(), i.preventDefault()
            })
        }
        var n = t("../../lib/helper"),
            r = t("../../lib/dom"),
        ...
        function s(t, e) {
            function i(i, s) {
                ...
                if (0 === i) {
                    ...
                    if (0 === o && s > 0 || o >= e.contentHeight - e.containerHeight && 0 > s) return !e.settings.wheelPropagation
                }
                var n = t.scrollLeft;
                if (0 === s) {
                    if (!e.scrollbarXActive) return !1;
                    if (0 === n && 0 > i || n >= e.contentWidth - e.containerWidth && i > 0) return !e.settings.wheelPropagation
                }
                return !0
            }
            var s = !1;
            ...
            e.event.bind(e.ownerDocument, "keydown", function(c) {
                if (!c.isDefaultPrevented || !c.isDefaultPrevented()) {
                    var d = n.matches(e.scrollbarX, ":focus") || n.matches(e.scrollbarY, ":focus");
                    if (s || d) {
                        ...
                        switch (c.which) {
                            ...
                            case 34:
                                ...
                                break;
                            case 35:
                                u = c.ctrlKey ? -e.contentHeight : -e.containerHeight;
                                break;
                            case 36:
                                u = c.ctrlKey ? t.scrollTop : e.containerHeight;
                                break;
                            default:
                                return
                        }
                        l(t, "top", t.scrollTop - u), l(t, "left", t.scrollLeft + p), a(t), r = i(p, u), r && c.preventDefault()
                    }
                }
            })
        }
    ...
    13: [function(t, e, i) {
        ...
        function s(t, e) {
            ...
            function o(e, i) {
                var s = t.querySelector("textarea:hover, .ps-child:hover");
                if (s) {
                    if ("TEXTAREA" !== s.tagName && !window.getComputedStyle(s).overflow.match(/(scroll|auto)/)) return !1;
                    var o = s.scrollHeight - s.clientHeight;
                    if (o > 0 && !(0 === s.scrollTop && i > 0 || s.scrollTop === o && 0 > i)) return !0;
                    var n = s.scrollLeft - s.clientWidth;
                    if (n > 0 && !(0 === s.scrollLeft && 0 > e || s.scrollLeft === n && e > 0)) return !0
                }
                return !1
            }
        ...
        function s(t, e) {
            ...
            function s() {
                c || (c = setInterval(function() {
                    return n.get(t) ? (a(t, "top", t.scrollTop + d.top), a(t, "left", t.scrollLeft + d.left), void r(t)) : void clearInterval(c)
                }, 50))
            }
            ...
            e.event.bind(e.ownerDocument, "selectionchange", function() {
                ...
                if (h) {
                    ...
                    i.x < n.left + 3 ? (d.left = -5, o.startScrolling(t, "x")) : i.x > n.right - 3 ? (d.left = 5, o.startScrolling(t, "x")) : d.left = 0, i.y < n.top + 3 ? (n.top + 3 - i.y < 5 ? d.top = -5 : d.top = -20, o.startScrolling(t, "y")) : i.y > n.bottom - 3 ? (i.y - n.bottom + 3 < 5 ? d.top = 5 : d.top = 20, o.startScrolling(t, "y")) : d.top = 0, 0 === d.top && 0 === d.left ? l() : s()
                }
            })
        }
        var o = t("../../lib/helper"),
    ...
    16: [function(t, e, i) {
        ...
        function s(t, e, i, s) {
            function o(i, s) {
                var o = t.scrollTop,
                    ...
                    a = Math.abs(s);
                if (a > r) {
                    if (0 > s && o === e.contentHeight - e.containerHeight || s > 0 && 0 === o) return !e.settings.swipePropagation
                } else if (r > a && (0 > i && n === e.contentWidth - e.containerWidth || i > 0 && 0 === n)) return !e.settings.swipePropagation;
                return !0
            }
            ...
            function f(t) {
                if (!w && e.settings.swipePropagation && u(t), !y && w && p(t)) {
                    var i = h(t),
                        s = {
                            pageX: i.pageX,
                            pageY: i.pageY
                    ...
                    var a = (new Date).getTime(),
                        c = a - m;
                    c > 0 && (v.x = n / c, v.y = r / c, m = a), o(n, r) && (t.stopPropagation(), t.preventDefault())
                }
            }

            function _() {
                !y && w && (w = !1, clearInterval(b), b = setInterval(function() {
                    return n.get(t) ? Math.abs(v.x) < .01 && Math.abs(v.y) < .01 ? void clearInterval(b) : (l(30 * v.x, 30 * v.y), v.x *= .8, void(v.y *= .8)) : void clearInterval(b)
                }, 10))
            }
            var g = {},
                m = 0,
                ...
                y = !1,
                w = !1;
            i && (e.event.bind(window, "touchstart", c), e.event.bind(window, "touchend", d), e.event.bind(t, "touchstart", u), e.event.bind(t, "touchmove", f), e.event.bind(t, "touchend", _)), s && (window.PointerEvent ? (e.event.bind(window, "pointerdown", c), e.event.bind(window, "pointerup", d), e.event.bind(t, "pointerdown", u), e.event.bind(t, "pointermove", f), e.event.bind(t, "pointerup", _)) : window.MSPointerEvent && (e.event.bind(window, "MSPointerDown", c), e.event.bind(window, "MSPointerUp", d), e.event.bind(t, "MSPointerDown", u), e.event.bind(t, "MSPointerMove", f), e.event.bind(t, "MSPointerUp", _)))
        }
        var o = t("../../lib/helper"),
            n = t("../instances"),
            r = t("../update-geometry"),
        ...
        e.exports = function(t) {
            if (o.env.supportsTouch || o.env.supportsIePointer) {
                var e = n.get(t);
                s(t, e, o.env.supportsTouch, o.env.supportsIePointer)
            }
        }
    }, {
        "../../lib/helper": 6,
    ...
    17: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            ...
            var i = n.add(t);
            i.settings = s.extend(i.settings, e), o.add(t, "ps-theme-" + i.settings.theme), i.settings.handlers.forEach(function(e) {
                a[e](t)
            }), l(t), r(t)
        }
    }, {
    ...
    18: [function(t, e, i) {
        ...
        function s(t) {
            ...
            var s = this;
            s.settings = a.clone(c), s.containerWidth = null, s.containerHeight = null, s.contentWidth = null, s.contentHeight = null, s.isRtl = "rtl" === d.css(t, "direction"), s.isNegativeScroll = function() {
                var e = t.scrollLeft,
                    i = null;
                return t.scrollLeft = -1, i = t.scrollLeft < 0, t.scrollLeft = e, i
            }(), s.negativeScrollAdjustment = s.isNegativeScroll ? t.scrollWidth - t.clientWidth : 0, s.event = new h, s.ownerDocument = t.ownerDocument || document, s.scrollbarXRail = d.appendTo(d.e("div", "ps-scrollbar-x-rail"), t), s.scrollbarX = d.appendTo(d.e("div", "ps-scrollbar-x"), s.scrollbarXRail), s.scrollbarX.setAttribute("tabindex", 0), s.event.bind(s.scrollbarX, "focus", e), s.event.bind(s.scrollbarX, "blur", i), s.scrollbarXActive = null, s.scrollbarXWidth = null, s.scrollbarXLeft = null, s.scrollbarXBottom = a.toInt(d.css(s.scrollbarXRail, "bottom")), s.isScrollbarXUsingBottom = s.scrollbarXBottom === s.scrollbarXBottom, s.scrollbarXTop = s.isScrollbarXUsingBottom ? null : a.toInt(d.css(s.scrollbarXRail, "top")), s.railBorderXWidth = a.toInt(d.css(s.scrollbarXRail, "borderLeftWidth")) + a.toInt(d.css(s.scrollbarXRail, "borderRightWidth")), d.css(s.scrollbarXRail, "display", "block"), s.railXMarginWidth = a.toInt(d.css(s.scrollbarXRail, "marginLeft")) + a.toInt(d.css(s.scrollbarXRail, "marginRight")), d.css(s.scrollbarXRail, "display", ""), s.railXWidth = null, s.railXRatio = null, s.scrollbarYRail = d.appendTo(d.e("div", "ps-scrollbar-y-rail"), t), s.scrollbarY = d.appendTo(d.e("div", "ps-scrollbar-y"), s.scrollbarYRail), s.scrollbarY.setAttribute("tabindex", 0), s.event.bind(s.scrollbarY, "focus", e), s.event.bind(s.scrollbarY, "blur", i), s.scrollbarYActive = null, s.scrollbarYHeight = null, s.scrollbarYTop = null, s.scrollbarYRight = a.toInt(d.css(s.scrollbarYRail, "right")), s.isScrollbarYUsingRight = s.scrollbarYRight === s.scrollbarYRight, s.scrollbarYLeft = s.isScrollbarYUsingRight ? null : a.toInt(d.css(s.scrollbarYRail, "left")), s.scrollbarYOuterWidth = s.isRtl ? a.outerWidth(s.scrollbarY) : null, s.railBorderYWidth = a.toInt(d.css(s.scrollbarYRail, "borderTopWidth")) + a.toInt(d.css(s.scrollbarYRail, "borderBottomWidth")), d.css(s.scrollbarYRail, "display", "block"), s.railYMarginHeight = a.toInt(d.css(s.scrollbarYRail, "marginTop")) + a.toInt(d.css(s.scrollbarYRail, "marginBottom")), d.css(s.scrollbarYRail, "display", ""), s.railYHeight = null, s.railYRatio = null
        }
    ...
    19: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            t.contains(e.scrollbarXRail) || (i = a.queryChildren(t, ".ps-scrollbar-x-rail"), i.length > 0 && i.forEach(function(t) {
                    ...
                    a.remove(t)
                }), a.appendTo(e.scrollbarYRail, t)), !e.settings.suppressScrollX && e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth ? (e.scrollbarXActive = !0, e.railXWidth = e.containerWidth - e.railXMarginWidth, e.railXRatio = e.containerWidth / e.railXWidth, e.scrollbarXWidth = s(e, n.toInt(e.railXWidth * e.containerWidth / e.contentWidth)), e.scrollbarXLeft = n.toInt((e.negativeScrollAdjustment + t.scrollLeft) * (e.railXWidth - e.scrollbarXWidth) / (e.contentWidth - e.containerWidth))) : e.scrollbarXActive = !1, !e.settings.suppressScrollY && e.containerHeight + e.settings.scrollYMarginOffset < e.contentHeight ? (e.scrollbarYActive = !0, e.railYHeight = e.containerHeight - e.railYMarginHeight, e.railYRatio = e.containerHeight / e.railYHeight, e.scrollbarYHeight = s(e, n.toInt(e.railYHeight * e.containerHeight / e.contentHeight)), e.scrollbarYTop = n.toInt(t.scrollTop * (e.railYHeight - e.scrollbarYHeight) / (e.contentHeight - e.containerHeight))) : e.scrollbarYActive = !1,
                e.scrollbarXLeft >= e.railXWidth - e.scrollbarXWidth && (e.scrollbarXLeft = e.railXWidth - e.scrollbarXWidth), e.scrollbarYTop >= e.railYHeight - e.scrollbarYHeight && (e.scrollbarYTop = e.railYHeight - e.scrollbarYHeight), o(t, e), e.scrollbarXActive ? r.add(t, "ps-active-x") : (r.remove(t, "ps-active-x"), e.scrollbarXWidth = 0, e.scrollbarXLeft = 0, c(t, "left", 0)), e.scrollbarYActive ? r.add(t, "ps-active-y") : (r.remove(t, "ps-active-y"), e.scrollbarYHeight = 0, e.scrollbarYTop = 0, c(t, "top", 0))
        }
    }, {
        "../lib/class": 2,
        "../lib/dom": 3,
    ...
    20: [function(t, e, i) {
        ...
        r.initEvent("ps-scroll-up", !0, !0), a.initEvent("ps-scroll-down", !0, !0), l.initEvent("ps-scroll-left", !0, !0), c.initEvent("ps-scroll-right", !0, !0), d.initEvent("ps-scroll-y", !0, !0), h.initEvent("ps-scroll-x", !0, !0), p.initEvent("ps-x-reach-start", !0, !0), u.initEvent("ps-x-reach-end", !0, !0), f.initEvent("ps-y-reach-start", !0, !0), _.initEvent("ps-y-reach-end", !0, !0), e.exports = function(t, e, i) {
            if ("undefined" == typeof t) throw "You must provide an element to the update-scroll function";
            if ("undefined" == typeof e) throw "You must provide an axis to the update-scroll function";
            if ("undefined" == typeof i) throw "You must provide a value to the update-scroll function";
            "top" === e && 0 >= i && (t.scrollTop = i = 0, t.dispatchEvent(f)), "left" === e && 0 >= i && (t.scrollLeft = i = 0, t.dispatchEvent(p));
            var g = n.get(t);
            "top" === e && i >= g.contentHeight - g.containerHeight && (i = g.contentHeight - g.containerHeight, i - t.scrollTop <= 1 ? i = t.scrollTop : t.scrollTop = i, t.dispatchEvent(_)), "left" === e && i >= g.contentWidth - g.containerWidth && (i = g.contentWidth - g.containerWidth, i - t.scrollLeft <= 1 ? i = t.scrollLeft : t.scrollLeft = i, t.dispatchEvent(u)), s || (s = t.scrollTop), o || (o = t.scrollLeft), "top" === e && s > i && t.dispatchEvent(r), "top" === e && i > s && t.dispatchEvent(a), "left" === e && o > i && t.dispatchEvent(l), "left" === e && i > o && t.dispatchEvent(c), "top" === e && (t.scrollTop = s = i, t.dispatchEvent(d)), "left" === e && (t.scrollLeft = o = i, t.dispatchEvent(h))
        }
    }, {
        "./instances": 18
    }],
...
function() {
    var t, e, i, s, o, n = {}.hasOwnProperty,
        r = function(t, e) {
            function i() {
                this.constructor = t
            }
    ...
    s = function() {
        ...
        return t.prototype.add_node = function(t) {
            ...
            for (e = this.parsed.length, this.parsed.push({
                    ...
                    disabled: t.disabled,
                    classes: t.className
                }), n = t.childNodes, r = [], s = 0, o = n.length; o > s; s++) i = n[s], r.push(this.add_option(i, e, t.disabled));
            return r
        ...
        var e, i, o, n, r;
        for (i = new s, r = t.childNodes, o = 0, n = r.length; n > o; o++) e = r[o], i.add_node(e);
        return i.parsed
    }, e = function() {
        function t(e, i) {
        ...
        return t.prototype.set_default_values = function() {
            ...
            var e, i, s, o, n, r, a;
            for (e = "", o = 0, a = this.results_data, n = 0, r = a.length; r > n && (i = a[n], s = "", s = i.group ? this.result_add_group(i) : this.result_add_option(i), "" !== s && (o++, e += s), (null != t ? t.first : void 0) && (i.selected && this.is_multiple ? this.choice_build(i) : i.selected && !this.is_multiple && this.single_set_selected_text(this.choice_label(i))), !(o >= this.max_shown_results)); n++);
            return e
            ...
            var t, e, i, s, o;
            for (s = this.results_data, o = [], e = 0, i = s.length; i > e; e++) t = s[e], t.selected ? o.push(t.selected = !1) : o.push(void 0);
            return o
        ...
        chosen: function(s) {
            return e.browser_is_supported() ? this.each(function(e) {
                var o, n;
                return o = t(this), n = o.data("chosen"), "destroy" === s ? void(n instanceof i && n.destroy()) : void(n instanceof i || o.data("chosen", new i(this, s)))
            }) : this
        }
    }), i = function(e) {
        function i() {
        ...
        return r(i, e), i.prototype.setup = function() {
            ...
            var e, i, s, o, n;
            if (t.length) {
                if (this.result_clear_highlight(), this.result_highlight = t, this.result_highlight.addClass("highlighted"), s = parseInt(this.search_results.css("maxHeight"), 10), n = this.search_results.scrollTop(), o = s + n, i = this.result_highlight.position().top + this.search_results.scrollTop(), e = i + this.result_highlight.outerHeight(), e >= o) return this.search_results.scrollTop(e - s > 0 ? e - s : 0);
            ...
            if (this.is_multiple) {
                for (s = 0, a = 0, n = "position:absolute; left: -1000px; top: -1000px; display:none;", r = ["font-size", "font-style", "font-weight", "font-family", "line-height", "text-transform", "letter-spacing"], l = 0, c = r.length; c > l; l++) o = r[l], n += o + ":" + this.search_field.css(o) + ";";
                return e = t("<div />", {
                    style: n
        ...
        t.Zebra_DatePicker = function(e, i) {
            var s, o, n, r, a, l, c, d, h, p, u, f, _, g, m, v, b, y, w, k, x, T, S, $, C, D, A, M, Y, E, X, P, H, I, F, W, L, O, R, j = {
                    always_visible: !1,
                    container: t("body"),
                    custom_classes: !1,
            ...
            var q = t(e),
                U = function(e) {
                    if (L = Math.floor(65536 * (1 + Math.random())).toString(16), !e) {
                        z.settings = t.extend({}, j, i), N.readonly = q.attr("readonly"), N.style = q.attr("style");
                        for (var T in q.data()) 0 === T.indexOf("zdp_") && (T = T.replace(/^zdp\_/, ""), void 0 !== j[T] && (z.settings[T] = "pair" == T ? t(q.data("zdp_" + T)) : q.data("zdp_" + T)));
                    }
                    z.settings.readonly_element && q.attr("readonly", "readonly");
                    var M = {
                            days: ["d", "j", "D"],
                            months: ["F", "m", "M", "n", "t"],
                            years: ["o", "Y", "y"]
                        ...
                        U = !1,
                        G = null;
                    for (G in M) t.each(M[G], function(t, e) {
                        z.settings.format.indexOf(e) > -1 && ("days" == G ? Y = !0 : "months" == G ? E = !0 : "years" == G && (U = !0))
                    });
                    X = Y && E && U ? ["years", "months", "days"] : !Y && E && U ? ["years", "months"] : Y && E && !U ? ["months", "days"] : Y || E || !U ? Y || !E || U ? ["years", "months", "days"] : ["months"] : ["years"], -1 == t.inArray(z.settings.view, X) && (z.settings.view = X[X.length - 1]), x = [], k = [], O = {}, R = [];
                    var K;
                    for (var V in z.settings.custom_classes) z.settings.custom_classes.hasOwnProperty(V) && R.push(V);
                    for (var Q = 0; Q < 2 + R.length; Q++) K = 0 === Q ? z.settings.disabled_dates : 1 == Q ? z.settings.enabled_dates : z.settings.custom_classes[R[Q - 2]], t.isArray(K) && K.length > 0 && t.each(K, function() {
                        for (var e = this.split(" "), i = 0; 4 > i; i++) {
                            e[i] || (e[i] = "*"), e[i] = e[i].indexOf(",") > -1 ? e[i].split(",") : new Array(e[i]);
                            for (var s = 0; s < e[i].length; s++)
                                if (e[i][s].indexOf("-") > -1) {
                                    var o = e[i][s].match(/^([0-9]+)\-([0-9]+)/);
                                    if (null !== o) {
                                        for (var n = ct(o[1]); n <= ct(o[2]); n++) - 1 == t.inArray(n, e[i]) && e[i].push(n + "");
                                        e[i].splice(s, 1)
                                    }
                                }
                            for (s = 0; s < e[i].length; s++) e[i][s] = isNaN(ct(e[i][s])) ? e[i][s] : ct(e[i][s])
                        }
                        0 === Q ? x.push(e) : 1 == Q ? k.push(e) : (void 0 === O[R[Q - 2]] && (O[R[Q - 2]] = []), O[R[Q - 2]].push(e))
                    });
                    var J, tt, et = new Date,
                        ot = z.settings.reference_date ? z.settings.reference_date : q.data("zdp_reference_date") && void 0 !== q.data("zdp_reference_date") ? q.data("zdp_reference_date") : et;
                    if (S = void 0, $ = void 0, f = ot.getMonth(), h = et.getMonth(), _ = ot.getFullYear(), p = et.getFullYear(), g = ot.getDate(), u = et.getDate(), z.settings.direction === !0) S = ot;
                    else if (z.settings.direction === !1) $ = ot, A = $.getMonth(), D = $.getFullYear(), C = $.getDate();
                    else if (!t.isArray(z.settings.direction) && st(z.settings.direction) && ct(z.settings.direction) > 0 || t.isArray(z.settings.direction) && ((J = B(z.settings.direction[0])) || z.settings.direction[0] === !0 || st(z.settings.direction[0]) && z.settings.direction[0] > 0) && ((tt = B(z.settings.direction[1])) || z.settings.direction[1] === !1 || st(z.settings.direction[1]) && z.settings.direction[1] >= 0)) S = J ? J : new Date(_, f, g + ct(t.isArray(z.settings.direction) ? z.settings.direction[0] === !0 ? 0 : z.settings.direction[0] : z.settings.direction)), f = S.getMonth(), _ = S.getFullYear(), g = S.getDate(), tt && +tt >= +S ? $ = tt : !tt && z.settings.direction[1] !== !1 && t.isArray(z.settings.direction) && ($ = new Date(_, f, g + ct(z.settings.direction[1]))), $ && (A = $.getMonth(), D = $.getFullYear(), C = $.getDate());
                    else if (!t.isArray(z.settings.direction) && st(z.settings.direction) && ct(z.settings.direction) < 0 || t.isArray(z.settings.direction) && (z.settings.direction[0] === !1 || st(z.settings.direction[0]) && z.settings.direction[0] < 0) && ((J = B(z.settings.direction[1])) || st(z.settings.direction[1]) && z.settings.direction[1] >= 0)) $ = new Date(_, f, g + ct(t.isArray(z.settings.direction) ? z.settings.direction[0] === !1 ? 0 : z.settings.direction[0] : z.settings.direction)), A = $.getMonth(), D = $.getFullYear(), C = $.getDate(), J && +$ > +J ? S = J : !J && t.isArray(z.settings.direction) && (S = new Date(D, A, C - ct(z.settings.direction[1]))), S && (f = S.getMonth(), _ = S.getFullYear(), g = S.getDate());
                    else if (t.isArray(z.settings.disabled_dates) && z.settings.disabled_dates.length > 0)
                        for (var at in x)
                            if ("*" == x[at][0] && "*" == x[at][1] && "*" == x[at][2] && "*" == x[at][3]) {
                                var ht = [];
                                if (t.each(k, function() {
                                        var t = this;
                                        "*" != t[2][0] && ht.push(parseInt(t[2][0] + ("*" == t[1][0] ? "12" : lt(t[1][0], 2)) + ("*" == t[0][0] ? "*" == t[1][0] ? "31" : new Date(t[2][0], t[1][0], 0).getDate() : lt(t[0][0], 2)), 10))
                                    }), ht.sort(), ht.length > 0) {
                                    var ut = (ht[0] + "").match(/([0-9]{4})([0-9]{2})([0-9]{2})/);
                                    _ = parseInt(ut[1], 10), f = parseInt(ut[2], 10) - 1, g = parseInt(ut[3], 10)
                                }
                                break
                            }
                    if (it(_, f, g)) {
                        for (; it(_);) S ? (_++, f = 0) : (_--, f = 11);
                        for (; it(_, f);) S ? (f++, g = 1) : (f--, g = new Date(_, f + 1, 0).getDate()), f > 11 ? (_++, f = 0, g = 1) : 0 > f && (_--, f = 11, g = new Date(_, f + 1, 0).getDate());
                        for (; it(_, f, g);) S ? g++ : g--, et = new Date(_, f, g), _ = et.getFullYear(), f = et.getMonth(), g = et.getDate();
                        et = new Date(_, f, g), _ = et.getFullYear(), f = et.getMonth(), g = et.getDate()
                    }
                    var ft = B(q.val() || (z.settings.start_date ? z.settings.start_date : ""));
                    if (ft && z.settings.strict && it(ft.getFullYear(), ft.getMonth(), ft.getDate()) && q.val(""), e || void 0 === S && void 0 === ft || dt(void 0 !== ft ? ft : S), !z.settings.always_visible) {
                        if (!e) {
                            if (z.settings.show_icon) {
                                "firefox" == pt.name && q.is('input[type="text"]') && "inline" == q.css("display") && q.css("display", "inline-block");
                                var _t = t('<span class="Zebra_DatePicker_Icon_Wrapper"></span>').css({
                                ...
                                "block" == q.css("display") && _t.css("width", q.outerWidth(!0)), q.wrap(_t).css({
                                    position: "relative",
                                    top: "auto",
                                    right: "auto",
                                    bottom: "auto",
                                    left: "auto"
                                }), n = t('<button type="button" class="Zebra_DatePicker_Icon' + ("disabled" == q.attr("disabled") ? " Zebra_DatePicker_Icon_Disabled" : "") + '">Pick a date</button>'), z.icon = n, P = z.settings.open_icon_only ? n : n.add(q)
                            } else P = q;
                            P.bind("click.Zebra_DatePicker_" + L, function(t) {
                                t.preventDefault(), q.attr("disabled") || (o.hasClass("dp_visible") ? z.hide() : z.show())
                            }), !z.settings.readonly_element && z.settings.pair && q.bind("blur.Zebra_DatePicker_" + L, function() {
                                var e;
                                (e = B(t(this).val())) && !it(e.getFullYear(), e.getMonth(), e.getDate()) && dt(e)
                            }), void 0 !== n && n.insertAfter(q)
                        }
                        if (void 0 !== n) {
                            n.attr("style", ""), z.settings.inside && n.addClass("Zebra_DatePicker_Icon_Inside_" + ("right" == z.settings.icon_position ? "Right" : "Left"));
                            var gt = q.outerWidth(),
                                mt = q.outerHeight(),
                                vt = parseInt(q.css("marginLeft"), 10) || 0,
                                bt = parseInt(q.css("marginTop"), 10) || 0,
                                yt = (n.outerWidth(), n.outerHeight()),
                                wt = parseInt(n.css("marginLeft"), 10) || 0;
                            parseInt(n.css("marginRight"), 10) || 0, z.settings.inside ? (n.css("top", bt + (mt - yt) / 2), "right" == z.settings.icon_position ? n.css("right", 0) : n.css("left", 0)) : n.css({
                                top: bt + (mt - yt) / 2,
                                left: vt + gt + wt
                            }), n.removeClass(" Zebra_DatePicker_Icon_Disabled"), "disabled" == q.attr("disabled") && n.addClass("Zebra_DatePicker_Icon_Disabled")
                        }
                    }
                    if (F = z.settings.show_select_today !== !1 && t.inArray("days", X) > -1 && !it(p, h, u) && z.settings.show_select_today, e) return t(".dp_previous", o).html(z.settings.header_navigation[0]), t(".dp_next", o).html(z.settings.header_navigation[1]), t(".dp_clear", o).html(z.settings.lang_clear_date), void t(".dp_today", o).html(z.settings.show_select_today);
                    t(window).bind("resize.Zebra_DatePicker_" + L + ", orientationchange.Zebra_DatePicker_" + L, function() {
                        z.hide(), void 0 !== n && (clearTimeout(W), W = setTimeout(function() {
                            z.update()
                        }, 100))
                    });
                    var kt = '<div class="Zebra_DatePicker"><table class="dp_header"><tr><td class="dp_previous">' + z.settings.header_navigation[0] + '</td><td class="dp_caption">&#032;</td><td class="dp_next">' + z.settings.header_navigation[1] + '</td></tr></table><table class="dp_daypicker"></table><table class="dp_monthpicker"></table><table class="dp_yearpicker"></table><table class="dp_footer"><tr><td class="dp_today"' + (z.settings.show_clear_date !== !1 ? ' style="width:50%"' : "") + ">" + F + '</td><td class="dp_clear"' + (F !== !1 ? ' style="width:50%"' : "") + ">" + z.settings.lang_clear_date + "</td></tr></table></div>";
                    o = t(kt), z.datepicker = o, r = t("table.dp_header", o), a = t("table.dp_daypicker", o), l = t("table.dp_monthpicker", o), c = t("table.dp_yearpicker", o), I = t("table.dp_footer", o), H = t("td.dp_today", I), d = t("td.dp_clear", I), z.settings.always_visible ? q.attr("disabled") || (z.settings.always_visible.append(o), z.show()) : z.settings.container.append(o), o.delegate("td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number)", "mouseover", function() {
                    ...
                    }), Z(t("td", r)), t(".dp_previous", r).bind("click", function() {
                        "months" == s ? v-- : "years" == s ? v -= 12 : --m < 0 && (m = 11, v--), nt()
                    }), t(".dp_caption", r).bind("click", function() {
                        s = "days" == s ? t.inArray("months", X) > -1 ? "months" : t.inArray("years", X) > -1 ? "years" : "days" : "months" == s ? t.inArray("years", X) > -1 ? "years" : t.inArray("days", X) > -1 ? "days" : "months" : t.inArray("days", X) > -1 ? "days" : t.inArray("months", X) > -1 ? "months" : "years", nt()
                    }), t(".dp_next", r).bind("click", function() {
                        "months" == s ? v++ : "years" == s ? v += 12 : 12 == ++m && (m = 0, v++), nt()
                    }), a.delegate("td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number)", "click", function() {
                        z.settings.select_other_months && t(this).attr("class") && null !== (ut = t(this).attr("class").match(/date\_([0-9]{4})(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])/)) ? rt(ut[1], ut[2] - 1, ut[3], "days", t(this)) : rt(v, m, ct(t(this).html()), "days", t(this))
                    }), l.delegate("td:not(.dp_disabled)", "click", function() {
                        var e = t(this).attr("class").match(/dp\_month\_([0-9]+)/);
                        m = ct(e[1]), -1 == t.inArray("days", X) ? rt(v, m, 1, "months", t(this)) : (s = "days", z.settings.always_visible && q.val(""), nt())
                    }), c.delegate("td:not(.dp_disabled)", "click", function() {
                        v = ct(t(this).html()), -1 == t.inArray("months", X) ? rt(v, 1, 1, "years", t(this)) : (s = "months", z.settings.always_visible && q.val(""), nt())
                    }), t(H).bind("click", function(e) {
                        e.preventDefault(), rt(p, h, u, "days", t(".dp_current", a)), z.settings.always_visible && z.show(), z.hide()
                    }), t(d).bind("click", function(e) {
                        e.preventDefault(), q.val(""), z.settings.always_visible ? (b = null, y = null, w = null, t("td.dp_selected", o).removeClass("dp_selected")) : (b = null, y = null, w = null, m = null, v = null), z.hide(), z.settings.onClear && "function" == typeof z.settings.onClear && z.settings.onClear.call(q, q)
                    }), z.settings.always_visible || (t(document).bind("mousedown.Zebra_DatePicker_" + L + ", touchstart.Zebra_DatePicker_" + L, function(e) {
                        if (o.hasClass("dp_visible")) {
                            if (z.settings.show_icon && t(e.target).get(0) === n.get(0)) return !0;
                            0 === t(e.target).parents().filter(".Zebra_DatePicker").length && z.hide()
                        }
                    }), t(document).bind("keyup.Zebra_DatePicker_" + L, function(t) {
                        o.hasClass("dp_visible") && 27 == t.which && z.hide()
                    })), nt()
                };
            z.clear_date = function() {
                t(d).trigger("click")
            }, z.destroy = function() {
                void 0 !== z.icon && z.icon.remove(), z.datepicker.remove(), z.settings.show_icon && !z.settings.always_visible && q.unwrap(), q.unbind("click.Zebra_DatePicker_" + L), q.unbind("blur.Zebra_DatePicker_" + L), t(document).unbind("keyup.Zebra_DatePicker_" + L), t(document).unbind("mousedown.Zebra_DatePicker_" + L), t(window).unbind("resize.Zebra_DatePicker_" + L), t(window).unbind("orientationchange.Zebra_DatePicker_" + L), q.removeData("Zebra_DatePicker"), q.attr("readonly", !!N.readonly), q.attr("style", N.style ? N.style : "")
            }, z.hide = function() {
                z.settings.always_visible || (et("hide"), o.removeClass("dp_visible").addClass("dp_hidden"), z.settings.onClose && "function" == typeof z.settings.onClose && z.settings.onClose.call(q, q))
            }, z.set_date = function(t) {
                var e;
                (e = B(t)) && !it(e.getFullYear(), e.getMonth(), e.getDate()) && (q.val(t), dt(e))
            }, z.show = function() {
                s = z.settings.view;
                var e = B(q.val() || (z.settings.start_date ? z.settings.start_date : ""));
                if (e ? (y = e.getMonth(), m = e.getMonth(), w = e.getFullYear(), v = e.getFullYear(), b = e.getDate(), it(w, y, b) && (z.settings.strict && q.val(""), m = f, v = _)) : (m = f, v = _), nt(), z.settings.always_visible) o.removeClass("dp_hidden").addClass("dp_visible");
                else {
                    if (z.settings.container.is("body")) {
                        var i = o.outerWidth(),
                            r = o.outerHeight(),
                            a = (void 0 !== n ? n.offset().left + n.outerWidth(!0) : q.offset().left + q.outerWidth(!0)) + z.settings.offset[0],
                            l = (void 0 !== n ? n.offset().top : q.offset().top) - r + z.settings.offset[1],
                            c = t(window).width(),
                            d = t(window).height(),
                            h = t(window).scrollTop(),
                            p = t(window).scrollLeft();
                        "below" == z.settings.default_position && (l = (void 0 !== n ? n.offset().top : q.offset().top) + z.settings.offset[1]), a + i > p + c && (a = p + c - i), p > a && (a = p), l + r > h + d && (l = h + d - r), h > l && (l = h), o.css({
                            left: a,
                            top: l
                        })
                    } else o.css({
                    ...
                    o.removeClass("dp_hidden").addClass("dp_visible"), et()
                }
                z.settings.onOpen && "function" == typeof z.settings.onOpen && z.settings.onOpen.call(q, q)
            }, z.update = function(e) {
                z.original_direction && (z.original_direction = z.direction), z.settings = t.extend(z.settings, e), U(!0)
            };
            var B = function(e) {
                    if (e += "", "" !== t.trim(e)) {
                        for (var i = G(z.settings.format), s = ["d", "D", "j", "l", "N", "S", "w", "F", "m", "M", "n", "Y", "y"], o = [], n = [], r = null, a = null, l = 0; l < s.length; l++)(r = i.indexOf(s[l])) > -1 && o.push({
                            character: s[l],
                            position: r
                        });
                        if (o.sort(function(t, e) {
                            ...
                            }), n.length && (o.reverse(), t.each(o, function(t, e) {
                                i = i.replace(e.character, "(" + n[n.length - t - 1] + ")")
                            }), n = new RegExp("^" + i + "$", "ig"), a = n.exec(e))) {
                            var c, d = new Date,
                                h = 1,
                                p = d.getMonth() + 1,
                                u = d.getFullYear(),
                                ...
                                g = !0;
                            if (o.reverse(), t.each(o, function(e, i) {
                                    if (!g) return !0;
                                    switch (i.character) {
                                        case "m":
                                        case "n":
                                        ...
                                        case "F":
                                        case "M":
                                            c = "D" == i.character || "l" == i.character ? z.settings.days : z.settings.months, g = !1, t.each(c, function(t, s) {
                                                if (g) return !0;
                                                if (a[e + 1].toLowerCase() == s.substring(0, "D" == i.character || "M" == i.character ? 3 : s.length).toLowerCase()) {
                                                    switch (i.character) {
                                                        case "D":
                                                            a[e + 1] = f[t].substring(0, 3);
                                                            break;
                                                        case "l":
                                                            a[e + 1] = f[t];
                                                            break;
                                ...
                                var m = new Date(u, (p || 1) - 1, h || 1);
                                if (m.getFullYear() == u && m.getDate() == (h || 1) && m.getMonth() == (p || 1) - 1) return m
                            }
                        }
                        return !1
                    }
                ...
                Z = function(t) {
                    "firefox" == pt.name ? t.css("MozUserSelect", "none") : "explorer" == pt.name ? t.bind("selectstart", function() {
                        return !1
                ...
                K = function(e) {
                    for (var i = "", s = e.getDate(), o = e.getDay(), n = z.settings.days[o], r = e.getMonth() + 1, a = z.settings.months[r - 1], l = e.getFullYear() + "", c = 0; c < z.settings.format.length; c++) {
                        var d = z.settings.format.charAt(c);
                        switch (d) {
                            case "y":
                                l = l.substr(2);
                            case "Y":
                            ...
                            case "n":
                                ...
                                break;
                            case "M":
                                a = t.isArray(z.settings.months_abbr) && void 0 !== z.settings.months_abbr[r - 1] ? z.settings.months_abbr[r - 1] : z.settings.months[r - 1].substr(0, 3);
                            case "F":
                                i += a;
                                break;
                            case "d":
                            ...
                            case "j":
                                ...
                                break;
                            case "D":
                                n = t.isArray(z.settings.days_abbr) && void 0 !== z.settings.days_abbr[o] ? z.settings.days_abbr[o] : z.settings.days[o].substr(0, 3);
                            case "l":
                                i += n;
                                break;
                            case "N":
                ...
                V = function() {
                    var e = new Date(v, m + 1, 0).getDate(),
                        i = new Date(v, m, 1).getDay(),
                        s = new Date(v, m, 0).getDate(),
                        o = i - z.settings.first_day_of_week;
                    o = 0 > o ? 7 + o : o, ot(z.settings.header_captions.days);
                    var n = "<tr>";
                    z.settings.show_week_number && (n += "<th>" + z.settings.show_week_number + "</th>");
                    for (var r = 0; 7 > r; r++) n += "<th>" + (t.isArray(z.settings.days_abbr) && void 0 !== z.settings.days_abbr[(z.settings.first_day_of_week + r) % 7] ? z.settings.days_abbr[(z.settings.first_day_of_week + r) % 7] : z.settings.days[(z.settings.first_day_of_week + r) % 7].substr(0, 2)) + "</th>";
                    for (n += "</tr><tr>", r = 0; 42 > r; r++) {
                        r > 0 && r % 7 === 0 && (n += "</tr><tr>"), r % 7 === 0 && z.settings.show_week_number && (n += '<td class="dp_week_number">' + ht(new Date(v, m, r - o + 1)) + "</td>");
                        var l = r - o + 1;
                        if (z.settings.select_other_months && (o > r || l > e)) {
                            var c = new Date(v, m, l),
                                d = c.getFullYear(),
                                f = c.getMonth(),
                                _ = c.getDate();
                            c = d + lt(f + 1, 2) + lt(_, 2)
                        }
                        if (o > r) n += '<td class="' + (z.settings.select_other_months && !it(d, f, _) ? "dp_not_in_month_selectable date_" + c : "dp_not_in_month") + '">' + (z.settings.select_other_months || z.settings.show_other_months ? lt(s - o + r + 1, z.settings.zero_pad ? 2 : 0) : "&nbsp;") + "</td>";
                        else if (l > e) n += '<td class="' + (z.settings.select_other_months && !it(d, f, _) ? "dp_not_in_month_selectable date_" + c : "dp_not_in_month") + '">' + (z.settings.select_other_months || z.settings.show_other_months ? lt(l - e, z.settings.zero_pad ? 2 : 0) : "&nbsp;") + "</td>";
                        else {
                            var g = (z.settings.first_day_of_week + r) % 7,
                                k = "",
                                x = tt(v, m, l);
                            it(v, m, l) ? (t.inArray(g, z.settings.weekend_days) > -1 ? k = "dp_weekend_disabled" : k += " dp_disabled", m == h && v == p && u == l && (k += " dp_disabled_current"), "" != x && (k += " " + x + "_disabled")) : (t.inArray(g, z.settings.weekend_days) > -1 && (k = "dp_weekend"), m == y && v == w && b == l && (k += " dp_selected"), m == h && v == p && u == l && (k += " dp_current"), "" != x && (k += " " + x)), n += "<td" + ("" !== k ? ' class="' + t.trim(k) + '"' : "") + ">" + ((z.settings.zero_pad ? lt(l, 2) : l) || "&nbsp;") + "</td>"
                        }
                    }
                    n += "</tr>", a.html(t(n)), z.settings.always_visible && (M = t("td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number)", a)), a.show()
                },
                Q = function() {
                    ot(z.settings.header_captions.months);
                    for (var e = "<tr>", i = 0; 12 > i; i++) {
                        i > 0 && i % 3 === 0 && (e += "</tr><tr>");
                        var s = "dp_month_" + i;
                        it(v, i) ? s += " dp_disabled" : y !== !1 && y == i && v == w ? s += " dp_selected" : h == i && p == v && (s += " dp_current"), e += '<td class="' + t.trim(s) + '">' + (t.isArray(z.settings.months_abbr) && void 0 !== z.settings.months_abbr[i] ? z.settings.months_abbr[i] : z.settings.months[i].substr(0, 3)) + "</td>"
                    }
                    e += "</tr>", l.html(t(e)), z.settings.always_visible && (Y = t("td:not(.dp_disabled)", l)), l.show()
                },
                J = function() {
                    ot(z.settings.header_captions.years);
                    for (var e = "<tr>", i = 0; 12 > i; i++) {
                        i > 0 && i % 3 === 0 && (e += "</tr><tr>");
                        var s = "";
                        it(v - 7 + i) ? s += " dp_disabled" : w && w == v - 7 + i ? s += " dp_selected" : p == v - 7 + i && (s += " dp_current"), e += "<td" + ("" !== t.trim(s) ? ' class="' + t.trim(s) + '"' : "") + ">" + (v - 7 + i) + "</td>"
                    }
                    e += "</tr>", c.html(t(e)), z.settings.always_visible && (E = t("td:not(.dp_disabled)", c)), c.show()
                },
                tt = function(e, i, s) {
                    var o, n, r;
                    "undefined" != typeof i && (i += 1);
                    for (n in R)
                        if (o = R[n], r = !1, t.isArray(O[o]) && t.each(O[o], function() {
                                if (!r) {
                                    var n = this;
                                    if ((t.inArray(e, n[2]) > -1 || t.inArray("*", n[2]) > -1) && ("undefined" != typeof i && t.inArray(i, n[1]) > -1 || t.inArray("*", n[1]) > -1) && ("undefined" != typeof s && t.inArray(s, n[0]) > -1 || t.inArray("*", n[0]) > -1)) {
                                        ...
                                        if (t.inArray(a, n[3]) > -1) return r = o
                                    }
                                }
                            }), r) return r;
                    return r || ""
                ...
                et = function(e) {
                    if ("explorer" == pt.name && 6 == pt.version) {
                        if (!T) {
                            var i = ct(o.css("zIndex")) - 1;
                            T = t("<iframe>", {
                ...
                it = function(e, i, s) {
                    ...
                    if (1e3 > e) return !0;
                    if (t.isArray(z.settings.direction) || 0 !== ct(z.settings.direction)) {
                        var o = ct(at(e, "undefined" != typeof i ? lt(i, 2) : "", "undefined" != typeof s ? lt(s, 2) : "")),
                            n = (o + "").length;
                        if (8 == n && ("undefined" != typeof S && o < ct(at(_, lt(f, 2), lt(g, 2))) || "undefined" != typeof $ && o > ct(at(D, lt(A, 2), lt(C, 2))))) return !0;
                        if (6 == n && ("undefined" != typeof S && o < ct(at(_, lt(f, 2))) || "undefined" != typeof $ && o > ct(at(D, lt(A, 2))))) return !0;
                        if (4 == n && ("undefined" != typeof S && _ > o || "undefined" != typeof $ && o > D)) return !0
                    }
                    "undefined" != typeof i && (i += 1);
                    var r = !1,
                        a = !1;
                    return t.isArray(x) && x.length && t.each(x, function() {
                        if (!r) {
                            var o = this;
                            if ((t.inArray(e, o[2]) > -1 || t.inArray("*", o[2]) > -1) && ("undefined" != typeof i && t.inArray(i, o[1]) > -1 || t.inArray("*", o[1]) > -1) && ("undefined" != typeof s && t.inArray(s, o[0]) > -1 || t.inArray("*", o[0]) > -1)) {
                                if ("*" == o[3]) return r = !0;
                                var n = new Date(e, i - 1, s).getDay();
                                if (t.inArray(n, o[3]) > -1) return r = !0
                            }
                        }
                    }), k && t.each(k, function() {
                        if (!a) {
                            var o = this;
                            if ((t.inArray(e, o[2]) > -1 || t.inArray("*", o[2]) > -1) && (a = !0, "undefined" != typeof i))
                                if (a = !0, t.inArray(i, o[1]) > -1 || t.inArray("*", o[1]) > -1) {
                                    if ("undefined" != typeof s)
                                        if (a = !0, t.inArray(s, o[0]) > -1 || t.inArray("*", o[0]) > -1) {
                                            if ("*" == o[3]) return a = !0;
                                            var n = new Date(e, i - 1, s).getDay();
                                            if (t.inArray(n, o[3]) > -1) return a = !0;
                                            a = !1
                                        } else a = !1
                                } else a = !1
                        }
                ...
                ot = function(e) {
                    !isNaN(parseFloat(m)) && isFinite(m) && (e = e.replace(/\bm\b|\bn\b|\bF\b|\bM\b/, function(e) {
                        switch (e) {
                            case "m":
                                return lt(m + 1, 2);
                            case "n":
                                return m + 1;
                            case "F":
                                return z.settings.months[m];
                            case "M":
                                return t.isArray(z.settings.months_abbr) && void 0 !== z.settings.months_abbr[m] ? z.settings.months_abbr[m] : z.settings.months[m].substr(0, 3);
                            default:
                                return e
                        }
                    })), !isNaN(parseFloat(v)) && isFinite(v) && (e = e.replace(/\bY\b/, v).replace(/\by\b/, (v + "").substr(2)).replace(/\bY1\b/i, v - 7).replace(/\bY2\b/i, v + 4)), t(".dp_caption", r).html(e)
                },
                nt = function() {
                    if ("" === a.text() || "days" == s) {
                        if ("" === a.text()) {
                            z.settings.always_visible || o.css("left", -1e3), o.css("visibility", "visible"), V();
                            var e = a.outerWidth(),
                                i = a.outerHeight();
                            l.css({
                                width: e,
                                ...
                                width: e,
                                height: i
                            }), r.css("width", e), I.css("width", e), o.css("visibility", "").addClass("dp_hidden")
                        } else V();
                        l.hide(), c.hide()
                    } else "months" == s ? (Q(), a.hide(), c.hide()) : "years" == s && (J(), a.hide(), l.hide());
                    if (z.settings.onChange && "function" == typeof z.settings.onChange && void 0 !== s) {
                        var n = "days" == s ? a.find("td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month)") : "months" == s ? l.find("td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month)") : c.find("td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month)");
                        n.each(function() {
                            var e;
                            "days" == s ? t(this).hasClass("dp_not_in_month_selectable") ? (e = t(this).attr("class").match(/date\_([0-9]{4})(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])/), t(this).data("date", e[1] + "-" + e[2] + "-" + e[3])) : t(this).data("date", v + "-" + lt(m + 1, 2) + "-" + lt(ct(t(this).text()), 2)) : "months" == s ? (e = t(this).attr("class").match(/dp\_month\_([0-9]+)/), t(this).data("date", v + "-" + lt(ct(e[1]) + 1, 2))) : t(this).data("date", ct(t(this).text()))
                        }), z.settings.onChange.call(q, s, n, q)
                    }
                    I.show(), z.settings.show_clear_date === !0 || 0 === z.settings.show_clear_date && "" !== q.val() || z.settings.always_visible && z.settings.show_clear_date !== !1 ? (d.show(), F ? (H.css("width", "50%"), d.css("width", "50%")) : (H.hide(), d.css("width", "100%"))) : (d.hide(), F ? H.show().css("width", "100%") : I.hide())
                },
                rt = function(t, e, i, s, o) {
                    var n = new Date(t, e, i, 12, 0, 0),
                        r = "days" == s ? M : "months" == s ? Y : E,
                        a = K(n);
                    q.val(a), z.settings.always_visible && (y = n.getMonth(), m = n.getMonth(), w = n.getFullYear(), v = n.getFullYear(), b = n.getDate(), r.removeClass("dp_selected"), o.addClass("dp_selected"), "days" == s && o.hasClass("dp_not_in_month_selectable") && z.show()), z.hide(), dt(n), z.settings.onSelect && "function" == typeof z.settings.onSelect && z.settings.onSelect.call(q, a, t + "-" + lt(e + 1, 2) + "-" + lt(i, 2), n, q, ht(n)), q.focus()
                },
                at = function() {
                ...
                dt = function(e) {
                    z.settings.pair && t.each(z.settings.pair, function() {
                        var i = t(this);
                ...
                ht = function(t) {
                    var e, i, s, o, n, r, a, l, c, d = t.getFullYear(),
                        h = t.getMonth() + 1,
                        p = t.getDate();
                    return 3 > h ? (e = d - 1, i = (e / 4 | 0) - (e / 100 | 0) + (e / 400 | 0), s = ((e - 1) / 4 | 0) - ((e - 1) / 100 | 0) + ((e - 1) / 400 | 0), o = i - s, n = 0, r = p - 1 + 31 * (h - 1)) : (e = d, i = (e / 4 | 0) - (e / 100 | 0) + (e / 400 | 0), s = ((e - 1) / 4 | 0) - ((e - 1) / 100 | 0) + ((e - 1) / 400 | 0), o = i - s, n = o + 1, r = p + ((153 * (h - 3) + 2) / 5 | 0) + 58 + o), a = (e + i) % 7, p = (r + a - n) % 7, l = r + 3 - p, c = 0 > l ? 53 - ((a - o) / 5 | 0) : l > 364 + o ? 1 : (l / 7 | 0) + 1
                },
                pt = {
                    init: function() {
    ...
    function(t) {
            ...
            var s = i.call(arguments, 1),
                o = function() {
                    if (this instanceof o) {
                        ...
                        var n = new n,
                            r = e.apply(n, s.concat(i.call(arguments)));
        ...
        var a = function(s, o, n) {
            this.VERSION = "2.1.4", this.input = s, this.plugin_count = n, this.old_to = this.old_from = this.update_tm = this.calc_count = this.current_plugin = 0, this.raf_id = this.old_min_interval = null, this.is_update = this.is_key = this.no_diapason = this.force_redraw = this.dragging = !1, this.is_start = !0, this.is_click = this.is_resize = this.is_active = this.is_finish = !1, this.$cache = {
                win: t(i),
                body: t(e.body),
                input: t(s),
                cont: null,
            ...
            s && (s = s.split(r.input_values_separator || o.input_values_separator || ";"), s[0] && s[0] == +s[0] && (s[0] = +s[0]), s[1] && s[1] == +s[1] && (s[1] = +s[1]), o && o.values && o.values.length ? (n.from = s[0] && o.values.indexOf(s[0]), n.to = s[1] && o.values.indexOf(s[1])) : (n.from = s[0] && +s[0], n.to = s[1] && +s[1])), t.extend(n, o), t.extend(n, r), this.options = n, this.validate(), this.result = {
        ...
        a.prototype = {
                ...
                changeLevel: function(t) {
                    switch (t) {
                        ...
                        case "from":
                            ...
                            break;
                        case "to":
                            this.coords.p_gap = this.toFixed(this.coords.p_pointer - this.coords.p_to_fake), this.$cache.s_to.addClass("state_hover"),
                                this.$cache.s_to.addClass("type_last"), this.$cache.s_from.removeClass("type_last");
                            break;
                        case "both":
                ...
                pointerDown: function(e, i) {
                    ...
                    2 !== i.button && ("both" === e && this.setTempMinInterval(), e || (e = this.target), this.current_plugin = this.plugin_count, this.target = e, this.dragging = this.is_active = !0, this.coords.x_gap = this.$cache.rs.offset().left, this.coords.x_pointer = s - this.coords.x_gap, this.calcPointerPercent(), this.changeLevel(e), r && t("*").prop("unselectable", !0), this.$cache.line.trigger("focus"), this.updateScene())
                },
                    ...
                    if (this.options) {
                        ...
                        if (!this.options.hide_from_to)
                            if ("single" === this.options.type) e = e ? this.decorate(i[this.result.from]) : this.decorate(this._prettify(this.result.from), this.result.from), this.$cache.single.html(e), this.calcLabels(), this.$cache.min[0].style.visibility = this.labels.p_single_left < this.labels.p_min + 1 ? "hidden" : "visible", this.$cache.max[0].style.visibility = this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? "hidden" : "visible";
                                ...
                                var s = Math.max(e, t);
                                this.labels.p_from_left + this.labels.p_from_fake >= this.labels.p_to_left ? (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", this.result.from === this.result.to ? ("from" === this.target ? this.$cache.from[0].style.visibility = "visible" : "to" === this.target ? this.$cache.to[0].style.visibility = "visible" : this.target || (this.$cache.from[0].style.visibility = "visible"), this.$cache.single[0].style.visibility = "hidden", s = t) : (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", s = Math.max(e, t))) : (this.$cache.from[0].style.visibility = "visible", this.$cache.to[0].style.visibility = "visible", this.$cache.single[0].style.visibility = "hidden"), this.$cache.min[0].style.visibility = i < this.labels.p_min + 1 ? "hidden" : "visible", this.$cache.max[0].style.visibility = s > 100 - this.labels.p_max - 1 ? "hidden" : "visible"
                            }
                    }
                },
                drawShadow: function() {
                ...
                convertToValue: function(t) {
                    var e, i, s = this.options.min,
                        ...
                        a = 0,
                        l = 0;
                    return 0 === t ? this.options.min : 100 === t ? this.options.max : (n && (a = e = n.length), r && (a = i = r.length), e && i && (a = e >= i ? e : i), 0 > s && (l = Math.abs(s), s = +(s + l).toFixed(a), o = +(o + l).toFixed(a)), t = (o - s) / 100 * t + s, (s = this.options.step.toString().split(".")[1]) ? t = +t.toFixed(s.length) : (t /= this.options.step, t *= this.options.step, t = +t.toFixed(0)), l && (t -= l), l = s ? +t.toFixed(s.length) : this.toFixed(t), l < this.options.min ? l = this.options.min : l > this.options.max && (l = this.options.max), l)
                },
                ...
                validate: function() {
                    ...
                    if ("string" == typeof i.min && (i.min = +i.min), "string" == typeof i.max && (i.max = +i.max), "string" == typeof i.from && (i.from = +i.from), "string" == typeof i.to && (i.to = +i.to), "string" == typeof i.step && (i.step = +i.step), "string" == typeof i.from_min && (i.from_min = +i.from_min), "string" == typeof i.from_max && (i.from_max = +i.from_max), "string" == typeof i.to_min && (i.to_min = +i.to_min), "string" == typeof i.to_max && (i.to_max = +i.to_max), "string" == typeof i.keyboard_step && (i.keyboard_step = +i.keyboard_step), "string" == typeof i.grid_num && (i.grid_num = +i.grid_num), i.max < i.min && (i.max = i.min), n)
                        for (i.p_values = [], i.min = 0, i.max = n - 1, i.step = 1, i.grid_num = i.max, i.grid_snap = !0, e = 0; e < n; e++) t = +o[e], isNaN(t) ? t = o[e] : (o[e] = t, t = this._prettify(t)), i.p_values.push(t);
                ...
                appendGrid: function() {
                    if (this.options.grid) {
                        var t, e, i = this.options;
                        t = i.max - i.min;
                        var s, o, n = i.grid_num,
                            r = 0,
                            a = 0,
                            l = 4,
                            c = 0,
                            d = "";
                        for (this.calcGridMargin(), i.grid_snap ? (n = t / i.step, r = this.toFixed(i.step / (t / 100))) : r = this.toFixed(100 / n), 4 < n && (l = 3), 7 < n && (l = 2), 14 < n && (l = 1), 28 < n && (l = 0), t = 0; t < n + 1; t++) {
                            for (s = l, a = this.toFixed(r * t), 100 < a && (a = 100, s -= 2, 0 > s && (s = 0)), this.coords.big[t] = a, o = (a - r * (t - 1)) / (s + 1), e = 1; e <= s && 0 !== a; e++) c = this.toFixed(a - o * e), d += '<span class="irs-grid-pol small" style="left: ' + c + '%"></span>';
                            d += '<span class="irs-grid-pol" style="left: ' + a + '%"></span>', c = this.convertToValue(a), c = i.values.length ? i.p_values[c] : this._prettify(c), d += '<span class="irs-grid-text js-grid-text-' + t + '" style="left: ' + a + '%">' + c + "</span>"
                        }
                        this.coords.big_num = Math.ceil(n + 1), this.$cache.cont.addClass("irs-with-grid"), this.$cache.grid.html(d), this.cacheGridLabels()
                    }
                },
                ...
                calcGridCollision: function(t, e, i) {
                    ...
                    for (s = 0; s < r && (o = s + t / 2, !(o >= r)); s += t) n = this.$cache.grid_labels[o][0], n.style.visibility = i[s] <= e[o] ? "visible" : "hidden"
                },
                ...
                return this.each(function() {
                    t.data(this, "ionRangeSlider") || t.data(this, "ionRangeSlider", new a(this, e, n++))
                })
            },
            function() {
        ...
        t.mask = {
            ...
            mask: function(i, r) {
                ...
                return r = t.extend({
                    ...
                    completed: null
                }, r), l = t.mask.definitions, c = [], d = u = i.length, h = null, t.each(i.split(""), function(t, e) {
                    "?" == e ? (u--, d = t) : l[e] ? (c.push(new RegExp(l[e])), null === h && (h = c.length - 1), d > t && (p = c.length - 1)) : c.push(null)
                }), this.trigger("unmask").each(function() {
                    function a() {
                        if (r.completed) {
                            for (var t = h; p >= t; t++)
                                if (c[t] && D[t] === _(t)) return;
                            r.completed.call(C)
                        }
                    }
                    ...
                    function v(t, e) {
                        ...
                        if (!(0 > t)) {
                            for (i = t, s = g(e); u > i; i++)
                                if (c[i]) {
                                    if (!(u > s && c[i].test(D[s]))) break;
                                    D[i] = D[s], D[s] = _(s), s = g(s)
                                }
                            S(), C.caret(Math.max(h, t))
                        }
                    }
                    ...
                    function b(t) {
                        ...
                        for (e = t, i = _(t); u > e; e++)
                            if (c[e]) {
                                if (s = g(e), o = D[e], D[e] = i, !(u > s && c[s].test(o))) break;
                                i = o
                            }
                    }
                    ...
                    function y() {
                        ...
                        if (f && f.length && f.length > t.length) {
                            ...
                            if (0 === e.begin)
                                for (; e.begin < h && !c[e.begin];) e.begin++;
                            C.caret(e.begin, e.begin)
                        } else {
                            for ($(!0); e.begin < u && !c[e.begin];) e.begin++;
                            C.caret(e.begin, e.begin)
                        }
                        a()
                    }
                    ...
                    function k(t) {
                        if (!C.prop("readonly")) {
                            ...
                            f = C.val(), 8 === n || 46 === n || s && 127 === n ? (e = C.caret(), i = e.begin, o = e.end, o - i === 0 && (i = 46 !== n ? m(i) : o = g(i - 1), o = 46 === n ? g(o) : o), T(i, o), v(i, o - 1), t.preventDefault()) : 13 === n ? w.call(this, t) : 27 === n && (C.val(M), C.caret(0, $()), t.preventDefault())
                        }
                    }

                    function x(e) {
                        if (!C.prop("readonly")) {
                            var i, s, o, r = e.which || e.keyCode,
                                l = C.caret();
                            if (!(e.ctrlKey || e.altKey || e.metaKey || 32 > r) && r && 13 !== r) {
                                if (l.end - l.begin !== 0 && (T(l.begin, l.end), v(l.begin, l.end - 1)), i = g(l.begin - 1), u > i && (s = String.fromCharCode(r), c[i].test(s))) {
                                    if (b(i), D[i] = s, S(), o = g(i), n) {
                                        var d = function() {
                    ...
                    function $(t) {
                        ...
                        for (e = 0, s = 0; u > e; e++)
                            if (c[e]) {
                                for (D[e] = _(e); s++ < o.length;)
                                    if (i = o.charAt(s - 1), c[e].test(i)) {
                                        D[e] = i, n = e;
                                        break
                                    }
                                if (s > o.length) {
                            ...
                            } else D[e] === o.charAt(s) && s++, d > e && (n = e);
                        return t ? S() : d > n + 1 ? r.autoclear || D.join("") === A ? (C.val() && C.val(""), T(0, u)) : S() : (S(), C.val(C.val().substring(0, n + 1))), d ? e : h
                    }
                    var C = t(this),
                        D = t.map(i.split(""), function(t, e) {
                            return "?" != t ? l[t] ? _(e) : t : void 0
                        }),
                        A = D.join(""),
                        M = C.val();
                    C.data(t.mask.dataName, function() {
                        return t.map(D, function(t, e) {
                            return c[e] && t != _(e) ? t : null
                        }).join("")
                        ...
                        if (!C.prop("readonly")) {
                            clearTimeout(e);
                            var t;
                            M = C.val(), t = $(), e = setTimeout(function() {
                                C.get(0) === document.activeElement && (S(), t == i.replace("?", "").length ? C.caret(0, t) : C.caret(t))
                            }, 10)
                        }
                    ...
                    }), o && n && C.off("input.mask").on("input.mask", y), $()
                })
            }
        })
    }), ! function(t) {
        function e() {
            var t = a();
            t !== l && (l = t, h.trigger("orientationchange"))
        }

        function i(e, i, s, o) {
            var n = s.type;
            s.type = i, t.event.dispatch.call(e, s, o), s.type = n
        }
        t.attrFn = t.attrFn || {};
        var s = navigator.userAgent.toLowerCase(),
            o = s.indexOf("chrome") > -1 && (s.indexOf("windows") > -1 || s.indexOf("macintosh") > -1 || s.indexOf("linux") > -1) && s.indexOf("mobile") < 0 && s.indexOf("android") < 0,
            n = {
                tap_pixel_range: 5,
        ...
        t.isTouchCapable = function() {
            ...
            setup: function() {
                var e = this,
                    s = t(e);
                s.on(n.startevent, function t(o) {
                    if (s.data("callee", t), o.which && 1 !== o.which) return !1;
                    var r = o.originalEvent,
                        a = {
                            position: {
                                x: n.touch_capable ? r.touches[0].screenX : o.screenX,
                                y: n.touch_capable ? r.touches[0].screenY : o.screenY
                            },
                            offset: {
                                x: Math.round(n.touch_capable ? r.changedTouches[0].pageX - s.offset().left : o.pageX - s.offset().left),
                                y: Math.round(n.touch_capable ? r.changedTouches[0].pageY - s.offset().top : o.pageY - s.offset().top)
                            },
                            time: Date.now(),
                            target: o.target
                        };
            ...
            setup: function() {
                var e = this,
                    s = t(e);
                s.on(n.endevent, function t(o) {
                    s.data("callee", t);
                    var r = o.originalEvent,
                        a = {
                            position: {
                                x: n.touch_capable ? r.changedTouches[0].screenX : o.screenX,
                                y: n.touch_capable ? r.changedTouches[0].screenY : o.screenY
                            },
                            offset: {
                                x: Math.round(n.touch_capable ? r.changedTouches[0].pageX - s.offset().left : o.pageX - s.offset().left),
                                y: Math.round(n.touch_capable ? r.changedTouches[0].pageY - s.offset().top : o.pageY - s.offset().top)
            ...
            setup: function() {
                var e, s = this,
                    ...
                    a = 0,
                    l = 0;
                o.on(n.startevent, function t(c) {
                    if (c.which && 1 !== c.which) return !1;
                    o.data("tapheld", !1), e = c.target;
                    ...
                    return r.x = c.originalEvent.targetTouches ? c.originalEvent.targetTouches[0].pageX : c.pageX, r.y = c.originalEvent.targetTouches ? c.originalEvent.targetTouches[0].pageY : c.pageY, a = r.x, l = r.y, n.hold_timer = window.setTimeout(function() {
                        var f = r.x - a,
                            _ = r.y - l;
                        if (c.target == e && (r.x == a && r.y == l || f >= -n.tap_pixel_range && f <= n.tap_pixel_range && _ >= -n.tap_pixel_range && _ <= n.tap_pixel_range)) {
                            o.data("tapheld", !0);
                            var g = Date.now(),
                                m = {
                                    x: n.touch_capable ? d.touches[0].screenX : c.screenX,
                                ...
                                v = {
                                    x: Math.round(n.touch_capable ? d.changedTouches[0].pageX - o.offset().left : c.pageX - o.offset().left),
                                    y: Math.round(n.touch_capable ? d.changedTouches[0].pageY - o.offset().top : c.pageY - o.offset().top)
                                },
                                b = g - h,
                                y = {
                                    startTime: h,
                            ...
                            o.data("callee1", t), i(s, "taphold", c, y)
                        }
                    }, n.taphold_threshold), !0
                }).on(n.endevent, function t() {
                    o.data("callee2", t), o.data("tapheld", !1), window.clearTimeout(n.hold_timer)
                }).on(n.moveevent, function t(e) {
                    o.data("callee3", t), a = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageX : e.pageX, l = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageY : e.pageY
                })
            },
            remove: function() {
            ...
            setup: function() {
                var e, s, o, r, a = this,
                    ...
                    c = null,
                    d = !1;
                l.on(n.startevent, function t(i) {
                    return (!i.which || 1 === i.which) && (l.data("doubletapped", !1), e = i.target, l.data("callee1", t), o = i.originalEvent, c || (c = {
                        position: {
                            x: n.touch_capable ? o.touches[0].screenX : i.screenX,
                            y: n.touch_capable ? o.touches[0].screenY : i.screenY
                        },
                        offset: {
                            x: Math.round(n.touch_capable ? o.changedTouches[0].pageX - l.offset().left : i.pageX - l.offset().left),
                            y: Math.round(n.touch_capable ? o.changedTouches[0].pageY - l.offset().top : i.pageY - l.offset().top)
                        },
                        time: Date.now(),
                        target: i.target
                    }), !0)
                }).on(n.endevent, function t(h) {
                    var p = Date.now(),
                        u = l.data("lastTouch") || p + 1,
                        f = p - u;
                    if (window.clearTimeout(s), l.data("callee2", t), f < n.doubletap_int && h.target == e && f > 100) {
                        l.data("doubletapped", !0), window.clearTimeout(n.tap_timer);
                        var _ = {
                                position: {
                                    x: n.touch_capable ? h.originalEvent.changedTouches[0].screenX : h.screenX,
                                    y: n.touch_capable ? h.originalEvent.changedTouches[0].screenY : h.screenY
                                },
                                offset: {
                                    x: Math.round(n.touch_capable ? o.changedTouches[0].pageX - l.offset().left : h.pageX - l.offset().left),
                                    y: Math.round(n.touch_capable ? o.changedTouches[0].pageY - l.offset().top : h.pageY - l.offset().top)
                                },
                                time: Date.now(),
                                target: h.target
                            },
                            g = {
                                firstTap: c,
                                secondTap: _,
                                interval: _.time - c.time
                            };
                        d || (i(a, "doubletap", h, g), c = null), d = !0, r = window.setTimeout(function() {
                            d = !1
                        }, n.doubletap_int)
                    } else l.data("lastTouch", p), s = window.setTimeout(function() {
            ...
            setup: function() {
                ...
                s.on(n.startevent, function t(e) {
                    return (!e.which || 1 === e.which) && (r = Date.now(), o = e.target, s.data("callee1", t), a.x = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageX : e.pageX, a.y = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageY : e.pageY, !0)
                }).on(n.endevent, function t(l) {
                    if (s.data("callee2", t), l.target == o) {
                        ...
                        n.tap_timer = window.setTimeout(function() {
                            if (!s.data("doubletapped") && !s.data("tapheld") && a.x == c && a.y == d) {
                                var t = l.originalEvent,
                                    o = {
                                        position: {
                                            x: n.touch_capable ? t.changedTouches[0].screenX : l.screenX,
                                            y: n.touch_capable ? t.changedTouches[0].screenY : l.screenY
                                        },
                                        offset: {
                                            x: Math.round(n.touch_capable ? t.changedTouches[0].pageX - s.offset().left : l.pageX - s.offset().left),
                                            y: Math.round(n.touch_capable ? t.changedTouches[0].pageY - s.offset().top : l.pageY - s.offset().top)
                                        },
                                        time: Date.now(),
                                        target: l.target
                                    };
                                o.time - r < n.taphold_threshold && i(e, "singletap", l, o)
                            }
                        }, n.doubletap_int)
                    }
                })
            ...
            setup: function() {
                ...
                r.on(n.startevent, function t(i) {
                    return r.data("callee1", t), (!i.which || 1 === i.which) && (a = !0, c.x = i.originalEvent.targetTouches ? i.originalEvent.targetTouches[0].pageX : i.pageX, c.y = i.originalEvent.targetTouches ? i.originalEvent.targetTouches[0].pageY : i.pageY, e = Date.now(), l = i.target, s = i.originalEvent.targetTouches ? i.originalEvent.targetTouches : [i], !0)
                }).on(n.endevent, function t(d) {
                    r.data("callee2", t);
                    var h = d.originalEvent.targetTouches ? d.originalEvent.changedTouches[0].pageX : d.pageX,
                        p = d.originalEvent.targetTouches ? d.originalEvent.changedTouches[0].pageY : d.pageY,
                        u = c.x - h,
                        f = c.y - p;
                    if (l == d.target && a && Date.now() - e < n.taphold_threshold && (c.x == h && c.y == p || u >= -n.tap_pixel_range && u <= n.tap_pixel_range && f >= -n.tap_pixel_range && f <= n.tap_pixel_range)) {
                        for (var _ = d.originalEvent, g = [], m = 0; m < s.length; m++) {
                            var v = {
                                position: {
                                    x: n.touch_capable ? _.changedTouches[m].screenX : d.screenX,
                                    y: n.touch_capable ? _.changedTouches[m].screenY : d.screenY
                                },
                                offset: {
                                    x: Math.round(n.touch_capable ? _.changedTouches[m].pageX - r.offset().left : d.pageX - r.offset().left),
                                    y: Math.round(n.touch_capable ? _.changedTouches[m].pageY - r.offset().top : d.pageY - r.offset().top)
                                },
                                time: Date.now(),
                                target: d.target
                            };
            ...
            setup: function() {
                function e(i) {
                    a = t(i.currentTarget), a.data("callee1", e), d.x = i.originalEvent.targetTouches ? i.originalEvent.targetTouches[0].pageX : i.pageX, d.y = i.originalEvent.targetTouches ? i.originalEvent.targetTouches[0].pageY : i.pageY, h.x = d.x, h.y = d.y, l = !0;
                    ...
                    o = {
                        ...
                        offset: {
                            x: Math.round(n.touch_capable ? s.changedTouches[0].pageX - a.offset().left : i.pageX - a.offset().left),
                            y: Math.round(n.touch_capable ? s.changedTouches[0].pageY - a.offset().top : i.pageY - a.offset().top)
                        },
                        time: Date.now(),
                        target: i.target
                    }
                ...
                function i(e) {
                    a = t(e.currentTarget), a.data("callee2", i), h.x = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageX : e.pageX, h.y = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageY : e.pageY;
                    var s, r = a.parent().data("xthreshold") ? a.parent().data("xthreshold") : a.data("xthreshold"),
                        p = a.parent().data("ythreshold") ? a.parent().data("ythreshold") : a.data("ythreshold"),
                        u = "undefined" != typeof r && r !== !1 && parseInt(r) ? parseInt(r) : n.swipe_h_threshold,
                        f = "undefined" != typeof p && p !== !1 && parseInt(p) ? parseInt(p) : n.swipe_v_threshold;
                    if (d.y > h.y && d.y - h.y > f && (s = "swipeup"), d.x < h.x && h.x - d.x > u && (s = "swiperight"), d.y < h.y && h.y - d.y > f && (s = "swipedown"), d.x > h.x && d.x - h.x > u && (s = "swipeleft"), void 0 != s && l) {
                        d.x = 0, d.y = 0, h.x = 0, h.y = 0, l = !1;
                        var _ = e.originalEvent,
                            g = {
                                position: {
                                    x: n.touch_capable ? _.touches[0].screenX : e.screenX,
                                    y: n.touch_capable ? _.touches[0].screenY : e.screenY
                                },
                                offset: {
                                    x: Math.round(n.touch_capable ? _.changedTouches[0].pageX - a.offset().left : e.pageX - a.offset().left),
                                    y: Math.round(n.touch_capable ? _.changedTouches[0].pageY - a.offset().top : e.pageY - a.offset().top)
                                },
                                time: Date.now(),
                                target: e.target
                            },
                            m = Math.abs(o.position.x - g.position.x),
                            v = Math.abs(o.position.y - g.position.y),
                            b = {
                                startEvnt: o,
                                endEvnt: g,
                                ...
                                xAmount: m,
                                yAmount: v,
                                duration: g.time - o.time
                            };
                        c = !0, a.trigger("swipe", b).trigger(s, b)
                    }
                }
                ...
                function s(e) {
                    a = t(e.currentTarget);
                    var i = "";
                    if (a.data("callee3", s), c) {
                        var r = a.data("xthreshold"),
                            d = a.data("ythreshold"),
                            h = "undefined" != typeof r && r !== !1 && parseInt(r) ? parseInt(r) : n.swipe_h_threshold,
                            p = "undefined" != typeof d && d !== !1 && parseInt(d) ? parseInt(d) : n.swipe_v_threshold,
                            u = e.originalEvent,
                            f = {
                                position: {
                                    x: n.touch_capable ? u.changedTouches[0].screenX : e.screenX,
                                    y: n.touch_capable ? u.changedTouches[0].screenY : e.screenY
                                },
                                offset: {
                                    x: Math.round(n.touch_capable ? u.changedTouches[0].pageX - a.offset().left : e.pageX - a.offset().left),
                                    y: Math.round(n.touch_capable ? u.changedTouches[0].pageY - a.offset().top : e.pageY - a.offset().top)
                                },
                                time: Date.now(),
                                target: e.target
                            };
                        o.position.y > f.position.y && o.position.y - f.position.y > p && (i = "swipeup"), o.position.x < f.position.x && f.position.x - o.position.x > h && (i = "swiperight"), o.position.y < f.position.y && f.position.y - o.position.y > p && (i = "swipedown"), o.position.x > f.position.x && o.position.x - f.position.x > h && (i = "swipeleft");
                        var _ = Math.abs(o.position.x - f.position.x),
                            g = Math.abs(o.position.y - f.position.y),
                            m = {
                                startEvnt: o,
                                endEvnt: f,
                ...
                a.on(n.startevent, e), a.on(n.moveevent, i), a.on(n.endevent, s)
            },
            remove: function() {
            ...
            setup: function() {
                function e(t, e) {
                    s = e, i(r, s ? "scrollstart" : "scrollend", t)
                }
                var s, o, r = this,
                    a = t(r);
                a.on(n.scrollevent, function t(i) {
                    a.data("callee", t), s || e(i, !0), clearTimeout(o), o = setTimeout(function() {
                        e(i, !1)
                    }, 50)
                })
            },
        ...
        var r, a, l, c, d, h = t(window),
            p = {
                0: !0,
                180: !0
            };
        if (n.orientation_support) {
            var u = window.innerWidth || h.width(),
                f = window.innerHeight || h.height(),
                _ = 50;
            c = u > f && u - f > _, d = p[window.orientation], (c && d || !c && !d) && (p = {
                "-90": !0,
                90: !0
            })
        }
        t.event.special.orientationchange = r = {
            setup: function() {
                return !n.orientation_support && (l = a(), h.on("throttledresize", e), !0)
            },
            teardown: function() {
                return !n.orientation_support && (h.off("throttledresize", e), !0)
            },
            add: function(t) {
                var e = t.handler;
            ...
            return t = n.orientation_support ? p[window.orientation] : e && e.clientWidth / e.clientHeight < 1.1, t ? "portrait" : "landscape"
        ...
        var g, m, v, b = 250,
            y = function() {
                m = Date.now(), v = m - w, v >= b ? (w = m, t(this).trigger("throttledresize")) : (g && window.clearTimeout(g), g = window.setTimeout(e, b - v))
            },
            w = 0;
        t.each({
            ...
            e.onreadystatechange = function() {
                if (4 === e.readyState) {
                    ...
                    i || (i = e._cachedDocument = document.implementation.createHTMLDocument(""), i.body.innerHTML = e.responseText, e._cachedTarget = {}), e._embeds.splice(0).map(function(s) {
                        ...
                        o || (o = e._cachedTarget[s.id] = i.getElementById(s.id)), t(s.svg, o)
                    })
                }
        ...
        function i(i) {
            function s() {
                for (var i = 0; i < h.length;) {
                    ...
                    if (a && /svg/i.test(a.nodeName)) {
                        ...
                        if (o && (!n.validate || n.validate(l, a, r))) {
                            a.removeChild(r);
                            var p = l.split("#"),
                                u = p.shift(),
                                f = p.join("#");
                            if (u.length) {
                                var _ = c[u];
                                _ || (_ = c[u] = new XMLHttpRequest, _.open("GET", u), _.send(), _._embeds = []), _._embeds.push({
                                    svg: a,
                                    id: f
                                }), e(_)
                            } else t(a, document.getElementById(f))
                        }
                    } else ++i
                }
                d(s, 67)
            ...
            var o, n = Object(i),
                ...
                a = /\bAppleWebKit\/(\d+)\b/,
                l = /\bEdge\/12\.(\d+)\b/;
            o = "polyfill" in n ? n.polyfill : r.test(navigator.userAgent) || (navigator.userAgent.match(l) || [])[1] < 10547 || (navigator.userAgent.match(a) || [])[1] < 537;
            var c = {},
