...
(function()
{
	var p = 
	{
		init: function(config)
		{
			...
			this._customResultButtonRect 	= {x: 675, y: 60, width: 100, height:45};
			this._selectImageRect			= {x: 30, y:130, width: 55, height:55};
			this._reelImageRect				= {x: 30, y: 190, width: 55, height:55};
			
			this._super("customResultView", -CustomResultView.WIDTH - config.paddingX, 50);
	...
	{
		if(this._open)
			this.setPosition(-CustomResultView.WIDTH - this._config.paddingX, this.y());
		else
			this.setPosition(0 - this._config.paddingX, this.y());
