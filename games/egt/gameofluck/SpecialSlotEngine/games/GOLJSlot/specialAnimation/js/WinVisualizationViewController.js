...
(function()
{
	var p =
	{
		init: function()
		{
			...
			this._view = new WinVisualizationView(new WinVisualizationViewConfig(spinMessage.reels, spinMessage.lines, spinMessage.scatters, spinMessage.expand ,settings.wildIndex, null, 
