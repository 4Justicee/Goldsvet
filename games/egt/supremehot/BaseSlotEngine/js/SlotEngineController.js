...
(function()
{
	var p =
	{
		...
		{
			var settings = GameSettings.getInstance();
			return settings.betValues[settings.currBetIndex]*settings.denominations[settings.currDenominationIndex][0]*(1);
		},
	...
	function onHomeClick() { this.dispatchEvent(new Event(SlotEngineMain.HIDE_GAME)); }
