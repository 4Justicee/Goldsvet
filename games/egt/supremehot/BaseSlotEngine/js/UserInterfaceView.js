	...
	var p = 
	{
		init: function(config)
		{
			...
			if(this._config.lineGame == true)
				...
				this._linesView = new WaysToPayView({currLine: this._config.currLine,lines: this._config.lines, lineGame: this._config.lineGame, fixedLines: this._config.fixedLinesCount });
			...
			this.denomButton = new Button("denomButtonOverlay", 532, 34);
			this.betButton = new Button("betButtonOverlay", 622, 34);

			this.homeButton = new Button("icons home", 1211 + config.paddingX, 100, {x: 0, y: -20, width: 100, height: 95});
			...
			this.settingsButton = new Button("icons settings", -config.paddingX, 100, {x: 0, y: -20, width: 100, height: 95});
			...
			this._bottomUIContainer.addChildren(this.denomButton, this.betButton);
