   $.Class("PlatformSettings", 
{
	...
	translations: 
	{
		session_override:
		{
			...
			mk: "                                                         !",
			ro: "Deconectare din cauza log  rilor multiple!",
			es: "  Desconectado debido a m  ltiples inicios de sesi  n!"
		},
		session_timeout:
		{
			...
			mk: "                                                                          .",
			ro: "Sesiunea dvs. a expirat din cauza inactivit    ii.",
			es: "Su sesi   ha expirado debido a su inactividad."
		},
		connection_closed:
		{
		...
		game_unavailable_error:
		{
			...
			bg: "                                          ,                                                          o                     .         ,                                                                   ,                                            .",
			ru: "                                                      ,                                                                                 .                     ,                                                                                                                 .",
			fr: "Une de vos parties reste inachev  e dans un jeu indisponible pour mobile. Veuillez essayer de le terminer par l'interm  diaire d'un ordinateur.",
			mk: "                                                ,                                                           .                  ,                                                                                         .",
			ro: "Ave  i un joc neterminat, care nu este disponibil pentru mobil. V   rug  m,   ncerca  i s     l finaliza  i folosind un computer.",
			es: "Tiene sin finalizar un juego que no est   disponible para m  vil. Por favor, trate de completarlo a trav  s de un ordenador.",
	...
	currencies: [
		...
		{name:'AMD', displayBanknotesOnly: 'yes'},
		...
		{name:'KZT', displayCreditsOnly: 'yes'},
		{name:'GYD', displayBanknotesOnly:'yes'}
	],
