...
(function()
{
	var p =
	{
		...
		setData: function(value)
		{
	        ...
	        else if(value.command == "bet")
			{
				...
				{
					if (value.complex.freeSpinsExpandWinAmount)
						value.winAmount -= value.complex.freeSpinsExpandWinAmount;
					settings.serverMessage = new SpinMessage(value.complex.reels, settings.lineGame ? value.complex.lines : value.complex.combos, value.complex.scatters, value.complex.expand, value.winAmount, value.complex.gambles, value.complex.jackpot, value.complex.freespins, value.complex.freespinsPerLine, value.complex.freespinScatters, value.complex.freeSpinsExpandLines, value.complex.freeSpinsExpandSymbol, value.complex.freeSpinsExpandWinAmount, value.gameNumber, value.state);
				}
	...
	function onResourcesLoaded(event)
	{
		...
		if(settings.specialExpandFrameVideo)
			videosQueue.addImageLoader(new ImageLoader(settings.specialExpandFrameVideo.src));
