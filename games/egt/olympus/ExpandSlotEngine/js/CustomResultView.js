...
(function()
{
	...
	function drawImages() {
		for(var i = 0;i < this._config.numImages; i++) {	
			this._context.clearRect( this._selectImageRect.x + i*this._selectImageRect.width, this._selectImageRect.y, 
									this._selectImageRect.width, this._selectImageRect.height);
	...
	function drawReelImages() {
		var len = (this._config.numReelImages+2)*this._config.numReels;
		for(var i = 0;i < len; i++)
		{
			if(i%(this._config.numReelImages+2) > 0 && i%(this._config.numReelImages+2) < this._config.numReelImages+1)
				drawReelImage.call(this, i, this._reels[i]);
		}
	}
