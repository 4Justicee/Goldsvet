	...
	var p =
	{
		init: function(currentState)
		{
			...
			else if (currentState.state == BaseMessage.STATE_FREESPIN)
			{
				...
				if (currentState.firstSpin && settings.restoreReels)
					this._freespinsSpinMessage = new SpinMessage(currentState.firstSpin.reels.slice(), currentState.firstSpin.lines ? currentState.firstSpin.lines.slice() : currentState.firstSpin.combos.slice(), currentState.firstSpin.scatters.slice(), currentState.firstSpin.expand.slice(), 0, 0, false, 0, null, [], 0, "");
		...
		spinReceived: function()
		{
			...
			if (spinMessage.freeSpins && !this._freespinsSpinMessage && settings.restoreReels)
				this._freespinsSpinMessage = new SpinMessage(spinMessage.reels, spinMessage.lines, spinMessage.scatters, [], 0, 0, false, 0, null, [], 0, "");
...
function onHomeClick() { document.location.href="../../../../"; }
