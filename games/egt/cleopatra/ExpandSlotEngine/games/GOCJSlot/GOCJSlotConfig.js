function GOCJSlotConfig(settings)
{
    ...
    this.prepareSettings = function()
	{
		...
		settings.soundsInfo[1] = {src: _engineType+"/games/"+_slotName+"/sounds/shortSounds.mp3", sounds:[
																							{name: "reelAccelerateSound", 		start:14, 	duration: 3.1},
																							{name: "stopScatter1", 				start:1, 	duration: 1.9},
																							{name: "stopScatter2", 				start:3, 	duration: 2},
																							{name: "stopScatter3", 				start:6, 	duration: 2},
																							{name: "stopScatter4", 				start:9, 	duration: 1.9},
																							{name: "stopScatter5", 				start:11, 	duration: 2},
																							{name: "bonusExpanding", 			start:17, 	duration: 0.35}
																							]};
		settings.soundsInfo[2] = {src: _engineType+"/games/"+_slotName+"/sounds/winSounds.mp3", sounds:[
																							{name: "winCat", 					start:0, 	duration: 3.6},
																							{name: "winScarabei", 				start:4, 	duration: 3.4},
																							{name: "winMan", 					start:8, 	duration: 5.4},
																							{name: "winCaesar", 				start:14, 	duration: 7.7},
																							{name: "winScatterFS",				start:24,	duration: 8.8},
																							{name: "creditAnimationSound", 		start:34, 	duration: 10}
																							]};
		settings.soundsInfo[5] = {src: _engineType+"/games/"+_slotName+"/sounds/freeSpinsSounds.mp3", sounds:[
																							{name: "introSound", 				start:0, 	duration: 12},
																							{name: "outroSound", 				start:13, 	duration: 9.4},
																							{name: "bonusSpecialRotating",		start:23, 	duration: 0.5},
																							{name: "bonusSpecialBlink", 		start:24, 	duration: 1.25}

																							]};

		settings.winSounds = [null, null, null, null, null, "winCat", "winScarabei", "winMan", "winCaesar", null];
		...
		settings.reelVideos = [
					{src:_engineType+"/games/"+_slotName+"/images/videos/10.jpg",	 		fps: 10, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/J.jpg",	 		fps: 10, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/Q.jpg",	 		fps: 10, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/K.jpg",	 		fps: 10, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/A.jpg",	 		fps: 10, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/cat.jpg",			fps: 6, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/scarabei.jpg",	 	fps: 12, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/man.jpg",	 		fps: 10, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/caesar.jpg", 		fps: 9, width: 175, height: 175, scale: 1,  length: 13 },
					{src:_engineType+"/games/"+_slotName+"/images/videos/scatter_wild.jpg",	fps: 12, width: 175, height: 175, scale: 1,  length: 30 }
					];
