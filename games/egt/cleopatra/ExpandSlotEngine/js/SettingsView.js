...
(function()
{
	var p =
	{
		init: function(config)
		{
			...
			this._super("settingsView", 0, 0, true);
			...
			this._settingsCloseButton = new SettingsPaytableCloseButton(0, 100, {x: 0, y: -20, width: 100, height: 94});
			this._paytableButton = new Button("paytableFromSettingsButton", 0, 516, {x:0, y:-20, width: 100, height: 94});
			this._paytableButton.addChild(new View("paytableFromSettingsButtonInfoIcon", 7, 5));
			this._helpButton = new Button("paytableFromSettingsButton", 1208, 516, {x:0, y:-20, width: 100, height: 94});
	...
	function setBetButtonText(index)
	{
		...
		{
			this._betButtons[index].setText(Utils.formatNumber(this._config.bets[index]*this._config.denominations[this._config.currentDenom]*(this._config.lineGame ? this._config.lines[this._config.currentLine]: this._config.comboCoeficients[this._config.currentLine]), 100, true));
		} 
		else
		{
