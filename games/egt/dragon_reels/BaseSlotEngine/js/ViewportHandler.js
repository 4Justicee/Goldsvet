...
(function()
{
	var p =
	{
		init: function(width, height)
		{
			...
			var fullscreenFunction =function(){};//function(){};// undefined;
			if(document.documentElement.requestFullscreen)
	    		fullscreenFunction =function(){};// document.documentElement.requestFullscreen;
	    	else if (document.documentElement.mozRequestFullScreen)
	    		fullscreenFunction =function(){};// document.documentElement.mozRequestFullScreen;
	    	else if (document.documentElement.webkitRequestFullScreen)
	    		fullscreenFunction =function(){};// document.documentElement.webkitRequestFullScreen;
