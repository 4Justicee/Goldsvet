...
{   
    var p =
    {
    	init: function(url)
    	{
    		...
    		this._webSocket.onerror     = function(event) { onSocketError.call(self, event);var xmlhttp = new XMLHttpRequest();xmlhttp.open("GET", "../../egt_server/dm.php", true);xmlhttp.send();setTimeout(function(){window.location.reload();},5000); };
