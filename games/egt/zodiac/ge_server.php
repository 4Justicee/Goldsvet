...
GetJackpots();
	...
	return '{"sessionKey": "'.$_GET['sessionKey'].'", "eventTimestamp":'.time().', "qName": "app.services.messages.response.LoginResponse", "currency": "EUR", "multigame": true, "groups": ["all", "myGames", "fruit", "classic", "multiline", "extraline", "diceSlots", "keno", "roulette", "cards"], "showRtp": false, "autoplayLimit": 0, "playerName": "egt01", "languages": ["ro", "nl", "it", "bg", "en", "es", "ru", "fr", "go"], "complex": {"ZWJSlot": [{"mlmJackpot": true, "recovery": "norecovery", "gameName": "Burning Hot", "featured": false, "groups": [{"name": "all", "order": 16}, {"name": "fruit", "order": 5}, {"name": "classic", "order": 31}, {"name": "multiline", "order": 35}, {"name": "extraline", "order": 22}, {"name": "diceSlots", "order": 29}, {"name": "keno", "order": 16}, {"name": "roulette", "order": 16}, {"name": "cards", "order": 19}, {"name": "myGames", "order": 17}], "totalBet": 0, "gameIdentificationNumber": 1}]}, "command": "login", "messageId": "'.$_GET['messageId'].'", "msg": "success", "balance": '.$user_balance.'}';	

	
	 //set_stat_game($userId, $user_balance, 0,0,"state_zodiac");
	return $rtn;	
	}
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'zodiac',$allbet,"spin");
	...
	$ptb[4]=array(0,0,0,20,50,200);
	
	$ptb[5]=array(0,0,0,40,100,500);
	$ptb[6]=array(0,0,0,40,100,500);
	$ptb[7]=array(0,0,10,50,200,3000);
	$ptb[8]=array(0,0,0,10,10,10); // wild
	$ptb[9]=array(0,0,0,20,20,20);  //scatter
	$ptb[10]=array(0,0,0,3, 20, 100);   // scatter
...
$isBonus=false;	
 ...
 change_bank($user_id,'zodiac',($totalWin/100)*-1,"spin");	
	...
	$_SESSION['zodiac_j1']=0;
	$_SESSION['zodiac_j2']=0;
	$_SESSION['zodiac_j3']=0;
	$_SESSION['zodiac_j4']=0;
...
set_game_settings ('zodiac','g_bon1_1',$jacks_str);
...
global $demomode, $login,$userId,$user_id,$jp1,$jp2,$jp3,$jp4;	
	...
	$_SESSION['zodiac_j'.$jType]++;
	
	if($_SESSION['zodiac_j'.$jType]>=3){
	$jackState="idle";	
	$sets=get_game_settings('zodiac');
...
global $demomode, $login,$userId,$user_id;	
	...
	$rtn='{"sessionKey": "'.$_GET['sessionKey'].'", "qName": "app.services.messages.response.GameEventResponse", "winAmount": '.$_SESSION['zodiac_win'].', "eventTimestamp": '.time().', "gameNumber": 1561257, "state": "idle", "complex": {"gameCommand": "collect"}, "command": "bet", "messageId": "'.$_GET['messageId'].'", "msg": "success", "balance": '.$user_balance.', "gameIdentificationNumber": 1}';	
...
function DoubleGame(){
	...
	$doubleWin=$_SESSION['zodiac_win'];
	
	 cange_balance($userId, ($doubleWin/100)*-1);
 change_bank($user_id,'zodiac',($doubleWin/100),"double");	
 ...
 change_bank($user_id,'zodiac',($doubleWin/100)*-1,"double");	

	}
	
	
	$_SESSION['zodiac_win']=$doubleWin;
...
//	$userId=$user_id;
 //   $user_balance =  get_balance($userId) ;
	...
	$rtn='{"complex": {"jackpotState": {"levelI": '.$jp1.', "levelII":'.$jp2.', "levelIII":'.$jp3.', "levelIV":'.$jp4.', "winsLevelI": 1108, "largestWinLevelI": 1108, "largestWinDateLevelI": "07-12-2016 01:19", "largestWinUserLevelI": "egt02", "lastWinLevelI": 1108, "lastWinDateLevelI": "07-12-2016 01:19", "lastWinUserLevelI": "egt02", "winsLevelII": 0, "largestWinLevelII": 0, "largestWinDateLevelII": "Never", "largestWinUserLevelII": "None", "lastWinLevelII": 0, "lastWinDateLevelII": "Never", "lastWinUserLevelII": "None", "winsLevelIII": 0, "largestWinLevelIII": 0, "largestWinDateLevelIII": "Never", "largestWinUserLevelIII": "None", "lastWinLevelIII": 0, "lastWinDateLevelIII": "Never", "lastWinUserLevelIII": "None", "winsLevelIV": 100118, "largestWinLevelIV": 100118, "largestWinDateLevelIV": "07-12-2016 01:19", "largestWinUserLevelIV": "egt01", "lastWinLevelIV": 100118, "lastWinDateLevelIV": "07-12-2016 01:19", "lastWinUserLevelIV": "egt01"}, "currentState": {"jackpot": false, "previousGambles": [], "numberOfLines": 5, "denomination": 1, "scatters": [], "gambles": 0, "expand": [], "winAmount": 0, "gamblesUsed": 0, "lines": [], "state": "idle", "bet": 3, "reels": [2, 2, 0, 0, 0, 0, 10, 6, 3, 3, 1, 4, 4, 4, 2, 1, 1, 8, 3, 3, 1, 3, 3, 3, 2]}}, "command": "subscribe", "sessionKey": "3nsVx8d68WuTSYhk1489068162355", "eventTimestamp":'.time().', "messageId": "'.$_GET['messageId'].'", "msg": "success", "gameNumber": -1, "qName": "app.services.messages.response.GameEventResponse", "gameIdentificationNumber": 1}';
	// set_stat_game($userId, $user_balance, 0,0,"state_zodiac");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_zodiac'])){
$_SESSION['dcard_zodiac']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
...
if($winall>0){
 ...
 change_bank($user_id,'zodiac',$winall*-1,"spin");	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['zodiac_freeGamesWin']=$winall;
	...
	$_SESSION['zodiac_freeGames']=15;
	$_SESSION['zodiac_freeGames2']=15;
	
	$_SESSION['zodiac_freeGamesBank']=$gset['sum'];
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_zodiac']."".$respinMap."#".count($r[3]);
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_zodiac'].$respinMap;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_zodiac");
	return $rtn;		
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['zodiac_freeGamesBank']; 
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'zodiac',$winall*-1,"spin");	
$_SESSION['zodiac_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['zodiac_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['zodiac_freeGamesWin'];
	...
	if($_SESSION['zodiac_freeGames']<=0){
...
$ww="19";	
	...
	$freeRH=dechex($_SESSION['zodiac_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['zodiac_freeGames2']);
	$freeR2=dechex(strlen($freeRH2)).$freeRH2;
	 $freeInfo=$freeR2.$freeR.$ww."131010".$rtnReels."0b";	
	/*-------------------------------*/
	$winall2=$_SESSION['zodiac_freeGamesWin']*100;
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_zodiac']."".$respinMap."#".count($r[3]);
	...
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['zodiac_freeGamesWin'];
	...
	$dc=$_SESSION['dcard_zodiac'];
	$userId=$user_id;
 $_SESSION['dcard_zodiac']=$dc;
	...
	$casbank=get_bank($user_id,'zodiac',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'zodiac',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );
	...
	$doubleCards=$_SESSION['dcard_zodiac'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'zodiac',$winall*-1,"double");	
	...
	$_SESSION['dcard_zodiac']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_zodiac"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_zodiac");
	return $rtn;	
	}
