...
function Settings()
{
	...
	this.value19 = false;
	if(!float_bet){
	this.value21 = {e:false,s:"\u20AC",m:"1",ts:null,cs:""};
	this.value22 = "\u20AC";
	this.value23 = 1;
	this.value24 = false;	
	}else{
	this.value21 = {e:true,s:"\u20AC",m:"0.01",ts:null,cs:"."};	
	this.value22 = "\u20AC";
	this.value23 = 0.01;
	this.value24 = true;
	}
	...
	this.value72 = {EUR:{s:"\u20AC",m:0.01,ts:null,cs:"."},USD:{s:"\u0024",m:0.01,ts:null,cs:"."},AUD:{s:"\u0024",m:0.01,ts:null,cs:"."},NOK:{s:"kr",m:0.01,ts:null,cs:"."},SEK:{s:"kr",m:0.01,ts:null,cs:"."}};
	this.value30 = "..";
	this.value40 = 1.0;
	this.value38 = false;
	this.value43 = false;
	...
	this.value74 = null;
	this.value75 = null;
	this.value76 = {u:true,a:true,d:9,f:true,s:"\u20AC",m:0.01,ts:null,cs:"."};
	this.value78 = {t:false,b:false,d:3000};
	this.value79 = 0;
	
	this.value8 = "./menu.php";
	this.value1001 = null;
	this.value1002 = ".";
	this.value1003 = "./logout.php";
	this.value1004 = null;
	this.value1005 = "";
	this.value1006 = true;
	this.value1007 = true;
