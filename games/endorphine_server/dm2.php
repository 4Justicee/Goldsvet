...
$socket = stream_socket_server("tcp://".$conf['url'].":".$conf['endorphine_port'], $errno, $errstr);
...
$opts = array(
  'http'=>array(
    ...
    'header'=>"Accept-language: en\r\n" .
              "Cookie: PHPSESSID=".$strArr->{'sessionKey'}."\r\n"
  )
);
...
//echo $strArr->{'payload'}->{'logic.api.gamelogic.FeatureID'};
...
//$math_f="http://"."casino50"."/games/endorphine/".$strArr->{'game'}."/ge_server.php?sessionKey=".$strArr->{'sessionKey'}."&sessionKey=".$strArr->{'sessionKey'}."&command=".$strArr->{'method'}."&bet=".$strArr->{'payload'}->{'bet_per_line'}."&lines=".$strArr->{'payload'}->{'num_of_lines'};
$math_f="http://".$_SERVER['HTTP_HOST']."/games/endorphine/".$strArr->{'game'}."/ge_server.php?sessionKey=".$strArr->{'sessionKey'}."&command=".$strArr->{'method'}."&bet=".$strArr->{'payload'}->{'bet_per_line'}."&lines=".$strArr->{'payload'}->{'num_of_lines'}."&pcard=".$strArr->{'payload'}->{'player_choice'}."&isFreeGame=".$isFree."&advancedCommand=".$strArr->{'payload'}->{'@type'};
//$math_f="http://"."casino50"."/games/amatic/phoenix/ge_server.php?ddd=".$ses[0];


if($strArr->{'method'}=="CLIENT_INFO"){
return;	
}
...
if($strArr->{'method'}=="GET_PAYTABLE_INFO"){
