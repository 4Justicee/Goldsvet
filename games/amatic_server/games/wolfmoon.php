...
$action="spin";
	...
	$rtn="";
	return $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$rtn="1000$loginId".$rtnBalance."10".$rtnReels."00281010101010101010101010291010101010101010101010101010101010101010101010101010101010101010101010101010101010".$_SESSION['dcard_wolfmoon']."f15fffff15fffff15fffff15fffff";
...
$gameState="05";	
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_wolfmoon']."".$respinMap."#".count($r[3]);
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101029".$winstr.$_SESSION['dcard_wolfmoon']."f15fffff15fffff15fffff15fffff";
...
$ww="1f";	
	...
	$freeR=dechex(strlen($freeRH)).$freeRH;
	 $freeInfo="15".$freeR.$ww."111010".$rtnReels."29";	
	/*-------------------------------*/
	$winall2=($_SESSION['wolfmoon_freeGamesWin']*100);
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_wolfmoon']."".$respinMap."#";
