...
$action="spin";
	...
	$rtn="#00101010";
	return $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$rtn="1000$loginId".$rtnBalance."10".$rtnReels."0005101010101006101010101010".$_SESSION['dcard_hotneon']."f15fffff15fffff15fffff15fffff";
...
$_SESSION['dcard_hotneon']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////////////////
	$betsArr=array(0.01,0.02,0.04,0.06,0.08,0.10,0.20,0.30,0.40,0.50,0.60,0.70,0.80,0.90,1.00);
...
$gameState="05";	
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_hotneon']."".$respinMap."#".count($r[3]);
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101006".$winstr.$_SESSION['dcard_hotneon'].$respinMap;
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['hotneon_freeGamesWin']*100;
