...
$action="spin";
	...
	$rtn="";
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$rtn="1000$loginId".$rtnBalance."10".$rtnReels."000510101010101010101010106101010101010".$_SESSION['dcard_bluedolphin']."f15fffff15fffff15fffff15fffff";
...
$_SESSION['dcard_bluedolphin']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////////////////
	$betsArr=array(0.02,0.03,0.04,0.05,0.10,0.15,0.20,0.25,0.30,0.35,0.40,0.45,0.50,0.60,0.70,0.80,0.90,1.00);
...
$gameState="06";	
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_bluedolphin']."".$respinMap."#".count($r[3]);
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101006".$winstr.$_SESSION['dcard_bluedolphin'].$respinMap;
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['bluedolphin_freeGamesWin']*100;
