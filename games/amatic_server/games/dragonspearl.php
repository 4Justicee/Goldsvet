...
$action="spin";
	...
	$rtn="";
	return $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$rtn="1000$loginId".$rtnBalance."10".$rtnReels."0032101010101010101010101033101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010".$_SESSION['dcard_dragonspearl']."f15fffff15fffff15fffff15fffff";
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dragonspearl_freeGamesT']=5;
...
$gameState="05";	
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_dragonspearl']."".$respinMap."#".count($r[3]);
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101033".$winstr.$_SESSION['dcard_dragonspearl']."f15fffff15fffff15fffff15fffff";
...
$ww="1f";	
	...
	$_SESSION['dragonspearl_freeGamesT']++;	
	$_SESSION['dragonspearl_freeGames']++;
	}
	$freeRH=dechex($_SESSION['dragonspearl_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	 $freeInfo="1".dechex($_SESSION['dragonspearl_freeGamesT']).$freeR.$ww."111010".$rtnReels."33";	
	/*-------------------------------*/
	$winall2=($_SESSION['dragonspearl_freeGamesWin']*100);
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_dragonspearl']."".$respinMap."#";
