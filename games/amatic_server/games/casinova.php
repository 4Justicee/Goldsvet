...
$action="spin";
	...
	$rtn="#00101010";
	return $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$rtn="1000$loginId".$rtnBalance."10".$rtnReels."0014101010101010101010101015101010101010101010101010101010101010101010".$_SESSION['dcard_casinova']."f15fffff15fffff15fffff15fffff";
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['casinova_freeGames']=15;
	
	$_SESSION['casinova_freeGamesBank']=$gset['sum'];
	
$gameState="05";	
	 $freeInfo="1f1f10111010101010101015";	
	}
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_casinova']."".$respinMap."#".$scatter_win2;
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101015".$winstr.$_SESSION['dcard_casinova'].$respinMap;
...
$ww="19";	
	...
	$freeR=dechex(strlen($freeRH)).$freeRH;
	 $freeInfo="1f".$freeR.$ww."111010".$rtnReels."15";	
	/*-------------------------------*/
	$winall2=$_SESSION['casinova_freeGamesWin']*100;
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_casinova']."".$respinMap."#".count($r[3]);
