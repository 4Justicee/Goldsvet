...
$action="spin";
	...
	$rtn="#00101010";
	return $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$rtn="1000$loginId".$rtnBalance."10".$rtnReels."000a10101010101010101010100b1010101010101010101010".$_SESSION['dcard_mermaidsgold']."f15fffff15fffff15fffff15fffff";
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['mermaidsgold_freeGames']=15;
...
$gameState="05";	
	...
	$rtn="1".$gameState."0".$loginId.$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_mermaidsgold']."".$respinMap."#".count($r[3]);
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_mermaidsgold'].$respinMap;
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['mermaidsgold_freeGamesWin']*100;
