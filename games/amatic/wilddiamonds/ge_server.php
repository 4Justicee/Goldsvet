...
$betsLength="0".$betsLength;
			...
			$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='wilddiamonds'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['wilddiamonds_freeGames2']."&".$_SESSION['wilddiamonds_freeGames']."&".$_SESSION['wilddiamonds_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['wilddiamonds_freeGames2']=$hisTmp2[4];
$_SESSION['wilddiamonds_freeGames']=$hisTmp2[5];
$_SESSION['wilddiamonds_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['wilddiamonds_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['wilddiamonds_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['wilddiamonds_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$hisWin=strlen($winall_h).$winall_h;
	...
	$rtn="".$hisState."0".$hisReel."10".$hisBalance.$hisWin."00".$minBets.$maxBets."0a".$f2.$f1."10101010100a0a0a1100".$hisReel."0000000000000000".$betsLength.$betString."0a10101010101010101010";
	echo $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_wilddiamonds']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."000a10101010101010101010100b1010101010101010101010".$_SESSION['dcard_wilddiamonds']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_wilddiamonds");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_wilddiamonds'])){
$_SESSION['dcard_wilddiamonds']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'wilddiamonds',$allbet,"spin");
...
$lin[9]=array(2,4,7,10,12);
 ...
 $psym[0]=array(0,0,0,50,500,2000);
$psym[1]=array(0,0,0,25,100,500);
$psym[2]=array(0,0,0,25,100,500);
$psym[3]=array(0,0,0,20,75,250);
$psym[4]=array(0,0,0,20,75,250);
$psym[5]=array(0,0,0,15,50,200);
$psym[6]=array(0,0,0,15,50,200);
...
$r[0]=array(1,10,10,10,2,7,7,7,4,5,5,5,5,1,7,7,7,0,0,0,0,0,6,6,6,6,4,6,4,6,6,6,3,8,8,8,4,9,9,9,3,9,3,10,10,10,1,7,7,7,7,2,10,10,10,4,6,6,6,1,8,8,8,2,8,2,9,9,9,9,1,9,1,5,5,5,3,10,10,10,10,10,4,10,4,7,3,7,3,9,4,9,9,9,9,2,4,5,5,5,3,8,8,8,3,2,8,8,8,3,10,10,10,10,5,5,1,5,5,5,0,0,0,0,10,10,10,10,4,9,9,9,9,6,6,6,6,3,2,9,9,9,9,2,3,8,8,8,1,8,1,8,6,6,6,6,4,10,10,10,10,3,9,9,9,9,4,6,6,6,6,4,7,7,7,7,3,10,3,10,10,10,10,7,7,7,7,3,9,9,9,9,4);
$r[1]=array(2,5,5,5,2,6,6,6,1,6,1,9,9,9,3,7,7,7,7,3,10,10,10,0,0,0,0,0,8,8,8,3,9,9,9,3,5,5,5,3,2,7,7,7,4,8,8,8,3,8,3,3,6,6,6,3,1,3,5,5,5,4,9,9,9,9,0,0,0,0,10,10,10,2,7,7,7,3,5,5,5,4,10,10,10,10,4,6,6,4,4,7,7,7,4,3,8,8,8,5,5,5,5,2,10,10,10,10,2,5,5,5,5,0,0,0,0,9,9,9,9,3,10,3,10,10,10,4,6,6,6,0,0,0,0,0,9,9,9,1,7,7,7,2,6,2,6,6,6,3,8,8,8,3,8,6,6,4,5,4,5,5,5,1,8,8,8,1,7,7,7,2,7,4,6,6,6,3,7,7,7,2,7,2,7,2,8,8,8,9,9,3,9,9,9,3,10,10,10,3,10,3,10,4,7,7,7,4,7,4);
$r[2]=array(2,4,1,4,8,8,8,1,5,1,5,5,5,2,4,8,4,8,8,8,0,0,0,0,6,4,10,10,10,4,1,4,8,8,8,2,8,2,3,2,7,7,7,1,9,9,9,4,1,4,8,8,8,3,1,3,8,3,1,3,4,1,8,8,8,8,8,8,1,8,1,10,10,10,3,1,3,8,8,8,4,1,3,4,1,7,7,7,0,0,0,0,6,4,3,8,8,8,2,4,2,9,9,9,3,8,8,8,1,2,4,5,5,5,4,5,4,1,4,8,8,8,1,8,1,4,3,1,3);
$r[3]=array(4,3,1,7,1,7,7,7,4,7,4,3,5,5,5,2,3,10,3,10,10,10,0,0,0,0,8,8,8,2,3,2,6,6,3,6,3,6,6,3,2,10,10,10,3,2,9,2,9,9,9,0,0,0,0,10,10,10,4,1,4,3,2,9,9,9,1,8,8,8,3,2,3,2,3,7,7,7,0,0,0,0,0,0,9,9,9,3,2,1,3,2,1,8,8,8,10,10,10,1,10,1,5,5,5,5,2,3,2,8,8,8,0,0,0,0,0,7,7,7,3,2,1,3,2,8,8,8,2,8,2,3,9,3,2,3,9,9,9,0,0,0,0,0,6,6,6,2,3,6,6,3,4,7,7,7,7,4,3,4,9,2,9,9,9,0,0,0,0,9,9,9,3,2,1,2,3,8,8,8,1,10,1,10,10,10,4,2,10,10,10,3,2,4,3);
$r[4]=array(1,10,1,10,10,10,2,4,7,7,7,3,1,3,8,8,8,3,9,9,9,0,0,0,0,0,0,0,5,5,5,1,9,9,9,4,2,6,6,3,6,2,3,8,8,8,1,10,10,10,1,5,5,5,10,10,10,2,10,4,2,9,9,9,4,9,9,4,6,6,6,6,2,4,5,5,5,1,3,7,7,7,4,8,4,8,8,8,3,4,6,6,6,3,7,3,7,7,7,2,3,9,9,9,0,0,0,0,0,6,6,6,1,5,5,5,2,10,10,10,2,7,7,7,2,6,2,6,6,6,6,0,0,0,0,0,8,8,8,8,4,10,10,10,4,10,4,1,5,5,5,4,1,4,7,7,7,1,3,2,3,1,6,6,6,2,3,9,9,9,4,2,1,4,7,7,7,3,1,4,8,8,8,8,3,2,4,2,5,5,5);	
...
if($winall>0){
 ...
 change_bank($user_id,'wilddiamonds',$winall*-1,"spin");	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['wilddiamonds_freeGamesWin']=$winall;
	...
	$_SESSION['rmap_wilddiamonds']=$map;	
	...
	$_SESSION['wilddiamonds_freeGames']=15;
	
	$_SESSION['wilddiamonds_freeGamesBank']=$gset['sum'];
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_wilddiamonds']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['wilddiamonds_freeGames2']."&".$_SESSION['wilddiamonds_freeGames']."&".$_SESSION['wilddiamonds_freeGamesBank']."&".$rtnBalance;
	...
	$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_wilddiamonds'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['wilddiamonds_freeGames2']."&".$_SESSION['wilddiamonds_freeGames']."&".$_SESSION['wilddiamonds_freeGamesBank']."&".$rtnBalance;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_wilddiamonds");
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['wilddiamonds_freeGamesBank']; 
...
$isWin=true;	
	...
	$_SESSION['wilddiamonds_freeGames']--;
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'wilddiamonds',$winall*-1,"spin");	
$_SESSION['wilddiamonds_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['wilddiamonds_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['wilddiamonds_freeGamesWin'];
	...
	if($_SESSION['wilddiamonds_freeGames']<=0){
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['wilddiamonds_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_wilddiamonds']."".$respinMap."#".count($r[3]);
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_wilddiamonds'].$respinMap;
	...
	$dc=$_SESSION['dcard_wilddiamonds'];
	$userId=$user_id;
 $_SESSION['dcard_wilddiamonds']=$dc;
	...
	$casbank=get_bank($user_id,'wilddiamonds',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'wilddiamonds',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_wilddiamonds'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'wilddiamonds',$winall*-1,"double");	
	...
	$_SESSION['dcard_wilddiamonds']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_wilddiamonds"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_wilddiamonds");
	return $rtn;	
	}
