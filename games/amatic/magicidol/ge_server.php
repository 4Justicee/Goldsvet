...
$betsLength="0".$betsLength;
			...
			$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='magicidol'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['magicidol_freeGames2']."&".$_SESSION['magicidol_freeGames']."&".$_SESSION['magicidol_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['magicidol_freeGames2']=$hisTmp2[4];
$_SESSION['magicidol_freeGames']=$hisTmp2[5];
$_SESSION['magicidol_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['magicidol_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['magicidol_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['magicidol_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$rtn="100010".$rtnBalance."10".$rtnReels."000a10101010101010101010100b1010101010101010101010".$_SESSION['dcard_magicidol']."f15fffff15fffff15fffff15fffff";
...
$_SESSION['dcard_magicidol']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
  ...
  /*paytab*/
		...
		$psym[7] = array( 0, 0, 0, 20, 100, 500 );  //scatter 
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['magicidol_freeGames2']=15;
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_magicidol']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['magicidol_freeGames2']."&".$_SESSION['magicidol_freeGames']."&".$_SESSION['magicidol_freeGamesBank']."&".$rtnBalance;
	...
	$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_magicidol'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['magicidol_freeGames2']."&".$_SESSION['magicidol_freeGames']."&".$_SESSION['magicidol_freeGamesBank']."&".$rtnBalance;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	//$winall_r=$_SESSION['magicidol_freeGamesWin'];
		$hisWin=$_SESSION['magicidol_freeGamesWin'];
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['magicidol_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_magicidol']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['magicidol_freeGames2']."&".$_SESSION['magicidol_freeGames']."&".$_SESSION['magicidol_freeGamesBank']."&".$rtnBalance;
	...
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['magicidol_freeGamesWin'];
