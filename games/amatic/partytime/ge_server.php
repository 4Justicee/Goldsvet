...
$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='partytime'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['partytime_freeGames2']."&".$_SESSION['partytime_freeGames']."&".$_SESSION['partytime_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['partytime_freeGames2']=$hisTmp2[4];
$_SESSION['partytime_freeGames']=$hisTmp2[5];
$_SESSION['partytime_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['partytime_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['partytime_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['partytime_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_partytime']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."000910101010101010101010100a1010101010101010101010".$_SESSION['dcard_partytime']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_partytime");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_partytime'])){
$_SESSION['dcard_partytime']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
		
}
	///////////////////////////////////////////
	$betsArr=explode(",",$conf['bets']);//(0.20, 0.30, 0.40, 0.50, 1.00, 1.50, 2.00, 2.50, 3.00, 4.00, 5.00);
	$_SESSION['fsbet_partytime']=$bet;
	$gBet=$betsArr[$bet];
	$allbet=$gBet*$lines;
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'partytime',$allbet,"spin");
...
if($winall>0){
 ...
 change_bank($user_id,'partytime',$winall*-1,"spin");	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['partytime_freeGamesWin']=$winall;
	...
	if($scatter_win==3){
	$_SESSION['partytime_freeGames']=7;
	$_SESSION['partytime_freeGames2']=7;
	}else if($scatter_win==4){
	$_SESSION['partytime_freeGames']=10;
	$_SESSION['partytime_freeGames2']=10;
	}else{
	$_SESSION['partytime_freeGames']=15;
	$_SESSION['partytime_freeGames2']=15;
	}
	
	$_SESSION['partytime_freeGamesBank']=$gset['sum'];
	
$gameState="05";	
	 $freeInfo="1".dechex($_SESSION['partytime_freeGames2'])."1".dechex($_SESSION['partytime_freeGames'])."1011101010101010100a";	
	}
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_partytime']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['partytime_freeGames2']."&".$_SESSION['partytime_freeGames']."&".$_SESSION['partytime_freeGamesBank']."&".$rtnBalance;
	...
	///////////////////////////////balance
		...
		$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100a".$winstr.$_SESSION['dcard_partytime'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['partytime_freeGames2']."&".$_SESSION['partytime_freeGames']."&".$_SESSION['partytime_freeGamesBank']."&".$rtnBalance;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_partytime");
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['partytime_freeGamesBank']; 
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'partytime',$winall*-1,"spin");	
$_SESSION['partytime_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['partytime_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['partytime_freeGamesWin'];
	$hisWin=$_SESSION['partytime_freeGamesWin'];
	...
	if($_SESSION['partytime_freeGames']<=0){
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['partytime_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_partytime']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['partytime_freeGames2']."&".$_SESSION['partytime_freeGames']."&".$_SESSION['partytime_freeGamesBank']."&".$rtnBalance;
	...
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."10101010101010101010100a".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['partytime_freeGamesWin'];
	...
	$dc=$_SESSION['dcard_partytime'];
	$userId=$user_id;
 $_SESSION['dcard_partytime']=$dc;
	...
	$casbank=get_bank($user_id,'partytime',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'partytime',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_partytime'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'partytime',$winall*-1,"double");	
	...
	$_SESSION['dcard_partytime']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_partytime"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_partytime");
	ge_serv_show_str($rtn);	
	}
