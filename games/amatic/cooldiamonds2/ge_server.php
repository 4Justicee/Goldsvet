...
$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='cooldiamonds2'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['cooldiamonds2_freeGames2']."&".$_SESSION['cooldiamonds2_freeGames']."&".$_SESSION['cooldiamonds2_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['cooldiamonds2_freeGames2']=$hisTmp2[4];
$_SESSION['cooldiamonds2_freeGames']=$hisTmp2[5];
$_SESSION['cooldiamonds2_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['cooldiamonds2_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['cooldiamonds2_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['cooldiamonds2_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$hisWin=strlen($winall_h).$winall_h;
	...
	$rtn="".$hisState."0".$hisReel."10".$hisBalance.$hisWin."00".$minBets.$maxBets."0a".$f2.$f1."10101010100a0a0a1100".$hisReel."0000000000000000".$betsLength.$betString."b1010101010101010101010";
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_cooldiamonds2']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."000a10101010101010101010100b1010101010101010101010".$_SESSION['dcard_cooldiamonds2']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_cooldiamonds2");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_cooldiamonds2'])){
$_SESSION['dcard_cooldiamonds2']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'cooldiamonds2',$allbet,"spin");
...
//0522b 0006662226665556663337111444666333222666333
//228 6667444111555222333555000444555444555111222
//c 44455522266655571116663336660007666555333666
//225 3330006667555111444222555444555444222
//225 7222000666444666333666111666555666333 5225000666222555666333711144466633322233322666674441115552223335550004445554447555226444555222666555711166633366600075553332263330006667555111444222555444555744422222272220006664446663336661116665553330
...
$r[2]=array(4, 4, 4, 5, 5, 5, 2, 2, 2, 6, 6, 6, 5, 5, 5, 7, 1, 1, 1, 6, 6, 6, 3, 3, 3, 6, 6, 6, 0, 0, 0, 7, 6, 6, 6, 5, 5, 5, 3, 3, 3, 6, 6, 6);
$r[3]=array(3, 3, 3, 0, 0, 0, 6, 6, 6, 7, 5, 5, 5, 1, 1, 1, 4, 4, 4, 2, 2, 2, 5, 5, 5, 4, 4, 4, 5, 5, 5, 4, 4, 4, 2, 2, 2);
$r[4]=array(7, 2, 2, 2, 0, 0, 0, 6, 6, 6, 4, 4, 4, 6, 6, 6, 3, 3, 3, 6, 6, 6, 1, 1, 1, 6, 6, 6, 5, 5, 5, 6, 6, 6, 3, 3, 3, 5);
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
  if($isBonus){
 change_bank($user_id,'cooldiamonds2',$winall*-1,"bonus");	
  }else{
 change_bank($user_id,'cooldiamonds2',$winall*-1,"spin");	
  }
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['cooldiamonds2_freeGamesWin']=$winall;
	...
	$_SESSION['rmap_cooldiamonds2']=$map;	
	...
	$_SESSION['cooldiamonds2_freeGames']=15;
	$_SESSION['cooldiamonds2_freeGames2']=15;
	
	$_SESSION['cooldiamonds2_freeGamesBank']=$gset['sum'];
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_cooldiamonds2']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['cooldiamonds2_freeGames2']."&".$_SESSION['cooldiamonds2_freeGames']."&".$_SESSION['cooldiamonds2_freeGamesBank']."&".$rtnBalance;
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_cooldiamonds2'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['cooldiamonds2_freeGames2']."&".$_SESSION['cooldiamonds2_freeGames']."&".$_SESSION['cooldiamonds2_freeGamesBank']."&".$rtnBalance;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_cooldiamonds2");
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['cooldiamonds2_freeGamesBank'];
 $casbank_full=get_bank($user_id,'cooldiamonds2',"bonus");
	if($_SESSION['cooldiamonds2_freeGamesBank']<0){
$_SESSION['cooldiamonds2_freeGamesBank']=0;
}
...
$isBonus=true;	
	...
	$_SESSION['cooldiamonds2_freeGames']--;
...
////////////////////////////////////
	            ...
	            if ( $s1 == $wild && $s2 == $s3 && $s3 == $s4 )
	            {
	                $s1 = $s2;
	               
	            }
	            if ( $s2 == $wild && $s1 == $s3 && $s3 == $s4 )
	            {
	                $s2 = $s3;
	               
	            }
	            if ( $s3 == $wild && $s1 == $s2 && $s2 == $s4 )
	            {
	                $s3 = $s2;
	               
	            }
	            if ( $s4 == $wild && $s1 == $s2 && $s2 == $s3)
	            {
	                $s4 = $s2;
	               
	            }
	            if ( $s1 == $wild && $s2 == $wild && $s3 == $s4 )
	            {
	                $s1 = $s3;
	                $s2 = $s3;
	               
	            }
	            if ( $s1 == $wild && $s3 == $wild && $s2 == $s4 )
	            {
	                $s1 = $s2;
	                $s3 = $s2;
	               
	            }
	            if ( $s1 == $wild && $s4 == $wild && $s2 == $s3 )
	            {
	                $s1 = $s2;
	                $s4 = $s2;
	               
	            }
	            if ( $s2 == $wild && $s3 == $wild && $s1 == $s4 )
	            {
	                $s2 = $s1;
	                $s3 = $s1;
	               
	            }
	            if ( $s2 == $wild && $s4 == $wild && $s1 == $s3 )
	            {
	                $s2 = $s1;
	                $s4 = $s1;
	               
	            }
	            if ( $s3 == $wild && $s4 == $wild && $s1 == $s2 )
	            {
	                $s3 = $s1;
	                $s4 = $s1;
				...
				if ($s1 == $wild && $s2 == $wild && $s3 == $wild && $s4 == $wild )
				{
					$s1 = $s5;
					$s2 = $s5;
					$s3 = $s5;
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'cooldiamonds2',$winall*-1,"bonus");	
$_SESSION['cooldiamonds2_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['cooldiamonds2_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['cooldiamonds2_freeGamesWin'];
	
	$hisWin=$_SESSION['cooldiamonds2_freeGamesWin'];
	...
	if($_SESSION['cooldiamonds2_freeGames']<=0){
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['cooldiamonds2_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_cooldiamonds2']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['cooldiamonds2_freeGames2']."&".$_SESSION['cooldiamonds2_freeGames']."&".$_SESSION['cooldiamonds2_freeGamesBank']."&".$rtnBalance;
	...
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['cooldiamonds2_freeGamesWin'];
	...
	$dc=$_SESSION['dcard_cooldiamonds2'];
	$userId=$user_id;
 $_SESSION['dcard_cooldiamonds2']=$dc;
	...
	$casbank=get_bank($user_id,'cooldiamonds2',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'cooldiamonds2',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_cooldiamonds2'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'cooldiamonds2',$winall*-1,"double");	
	...
	$_SESSION['dcard_cooldiamonds2']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_cooldiamonds2"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_cooldiamonds2");
	return $rtn;	
	}
