...
$betsLength="0".$betsLength;
	...
	$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='mermaidsgold'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['mermaidsgold_freeGames2']."&".$_SESSION['mermaidsgold_freeGames']."&".$_SESSION['mermaidsgold_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['mermaidsgold_freeGames2']=$hisTmp2[4];
$_SESSION['mermaidsgold_freeGames']=$hisTmp2[5];
$_SESSION['mermaidsgold_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['mermaidsgold_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['mermaidsgold_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['mermaidsgold_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_mermaidsgold']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."000a10101010101010101010100b1010101010101010101010".$_SESSION['dcard_mermaidsgold']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_mermaidsgold");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_mermaidsgold'])){
$_SESSION['dcard_mermaidsgold']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'mermaidsgold',$allbet,"spin");
...
if($winall>0){
 ...
 change_bank($user_id,'mermaidsgold',$winall*-1,"spin");	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['mermaidsgold_freeGamesWin']=$winall;
	$hisWin=$_SESSION['mermaidsgold_freeGamesWin'];
	...
	$_SESSION['rmap_mermaidsgold']=$map;	
	...
	$_SESSION['mermaidsgold_freeGames']=10;
	$_SESSION['mermaidsgold_freeGames2']=10;
	
	$_SESSION['mermaidsgold_freeGamesBank']=$gset['sum'];
	
$gameState="05";	
	 $freeInfo="1a1a1013101010101010100b";	
	}
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_mermaidsgold']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['mermaidsgold_freeGames2']."&".$_SESSION['mermaidsgold_freeGames']."&".$_SESSION['mermaidsgold_freeGamesBank']."&".$_SESSION['double_balance'];
	...
	$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_mermaidsgold'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['mermaidsgold_freeGames2']."&".$_SESSION['mermaidsgold_freeGames']."&".$_SESSION['mermaidsgold_freeGamesBank']."&".$_SESSION['double_balance'];
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_mermaidsgold");
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['mermaidsgold_freeGamesBank']; 
...
$isBonus=true;	
	...
	$_SESSION['mermaidsgold_freeGames']--;
...
if(($s3==$i || $s3==$wild) && ($s5==$i || $s5==$wild) && ($s4==$i || $s4==$wild)){
...
if(($s2==$i || $s2==$wild) && ($s5==$i || $s5==$wild) && ($s4==$i || $s4==$wild) && ($s3==$i || $s3==$wild)){
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'mermaidsgold',$winall*-1,"spin");	
$_SESSION['mermaidsgold_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['mermaidsgold_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['mermaidsgold_freeGamesWin'];
	$hisWin=$_SESSION['mermaidsgold_freeGamesWin'];
	...
	if($_SESSION['mermaidsgold_freeGames']<=0){
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['mermaidsgold_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_mermaidsgold']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['mermaidsgold_freeGames2']."&".$_SESSION['mermaidsgold_freeGames']."&".$_SESSION['mermaidsgold_freeGamesBank']."&".$_SESSION['double_balance'];
	...
	//$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['mermaidsgold_freeGamesWin'];
	...
	$dc=$_SESSION['dcard_mermaidsgold'];
	$userId=$user_id;
 $_SESSION['dcard_mermaidsgold']=$dc;
	...
	$casbank=get_bank($user_id,'mermaidsgold',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'mermaidsgold',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_mermaidsgold'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'mermaidsgold',$winall*-1,"double");	
	...
	$_SESSION['dcard_mermaidsgold']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_mermaidsgold"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_mermaidsgold");
	ge_serv_show_str( $rtn);	
	}
