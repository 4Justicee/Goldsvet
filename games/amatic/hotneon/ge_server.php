...
$betsLength="0".$betsLength;
		...
		$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='hotneon'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['hotneon_freeGames2']."&".$_SESSION['hotneon_freeGames']."&".$_SESSION['hotneon_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['hotneon_freeGames2']=$hisTmp2[4];
$_SESSION['hotneon_freeGames']=$hisTmp2[5];
$_SESSION['hotneon_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['hotneon_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['hotneon_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['hotneon_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$hisWin=strlen($winall_h).$winall_h;
	...
	$rtn="".$hisState."0".$hisReel."10".$hisBalance.$hisWin."00".$minBets.$maxBets."05".$f2.$f1."10101010100505011100".$hisReel."0000000000000000".$betsLength.$betString."61010101010101010101010#00101010";
	echo $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_hotneon']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."0005101010101006101010101010".$_SESSION['dcard_hotneon']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_hotneon");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_hotneon'])){
$_SESSION['dcard_hotneon']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'hotneon',$allbet,"spin");
...
if($winall>0){
 ...
 change_bank($user_id,'hotneon',$winall*-1,"spin");	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['hotneon_freeGamesWin']=$winall;
	...
	$_SESSION['hotneon_freeGames']=15;
	$_SESSION['hotneon_freeGames2']=15;
	
	$_SESSION['hotneon_freeGamesBank']=$gset['sum'];
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_hotneon']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['hotneon_freeGames2']."&".$_SESSION['hotneon_freeGames']."&".$_SESSION['hotneon_freeGamesBank']."&".$rtnBalance;
	...
	$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101006".$winstr.$_SESSION['dcard_hotneon'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['hotneon_freeGames2']."&".$_SESSION['hotneon_freeGames']."&".$_SESSION['hotneon_freeGamesBank']."&".$rtnBalance;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_hotneon");
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['hotneon_freeGamesBank']; 
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'hotneon',$winall*-1,"spin");	
$_SESSION['hotneon_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['hotneon_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['hotneon_freeGamesWin'];
	$hisWin=$_SESSION['hotneon_freeGamesWin'];	
	...
	if($_SESSION['hotneon_freeGames']<=0){
...
$ww="19";	
	...
	$freeRH2=dechex($_SESSION['hotneon_freeGames2']);
	$freeR2=dechex(strlen($freeRH2)).$freeRH2;
	 $freeInfo=$freeR2.$freeR.$ww."131010".$rtnReels."06";	
	/*-------------------------------*/
	$winall2=$_SESSION['hotneon_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_hotneon']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['hotneon_freeGames2']."&".$_SESSION['hotneon_freeGames']."&".$_SESSION['hotneon_freeGamesBank']."&".$rtnBalance;
	...
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."101010101010101010101006".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['hotneon_freeGamesWin'];
	...
	$dc=$_SESSION['dcard_hotneon'];
	$userId=$user_id;
 $_SESSION['dcard_hotneon']=$dc;
	...
	$casbank=get_bank($user_id,'hotneon',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'hotneon',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_hotneon'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'hotneon',$winall*-1,"double");	
	...
	$_SESSION['dcard_hotneon']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_hotneon"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_hotneon");
	ge_serv_show_str($rtn);	
	}
