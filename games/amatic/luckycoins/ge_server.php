...
$betsLength="0".$betsLength;
			...
			$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='luckycoins'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['luckycoins_freeGames2']."&".$_SESSION['luckycoins_freeGames']."&".$_SESSION['luckycoins_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['luckycoins_freeGames2']=$hisTmp2[4];
$_SESSION['luckycoins_freeGames']=$hisTmp2[5];
$_SESSION['luckycoins_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['luckycoins_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['luckycoins_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['luckycoins_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_luckycoins']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."000a10101010101010101010100b1010101010101010101010".$_SESSION['dcard_luckycoins']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_luckycoins");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_luckycoins'])){
$_SESSION['dcard_luckycoins']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'luckycoins',$allbet,"spin");
...
if($winall>0){
 ...
 change_bank($user_id,'luckycoins',$winall*-1,"spin");	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['luckycoins_freeGamesWin']=$winall;
	...
	$_SESSION['luckycoins_freeGames']=15;
	$_SESSION['luckycoins_freeGames2']=15;
	
	$_SESSION['luckycoins_freeGamesBank']=$gset['sum'];
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_luckycoins']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['luckycoins_freeGames2']."&".$_SESSION['luckycoins_freeGames']."&".$_SESSION['luckycoins_freeGamesBank']."&".$rtnBalance;
	...
	///////////////////////////////balance
		...
		$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_luckycoins'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['luckycoins_freeGames2']."&".$_SESSION['luckycoins_freeGames']."&".$_SESSION['luckycoins_freeGamesBank']."&".$rtnBalance;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_luckycoins");
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['luckycoins_freeGamesBank']; 
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'luckycoins',$winall*-1,"spin");	
$_SESSION['luckycoins_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['luckycoins_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['luckycoins_freeGamesWin'];
	$hisWin=$_SESSION['luckycoins_freeGamesWin'];	
	...
	if($_SESSION['luckycoins_freeGames']<=0){
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['luckycoins_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_luckycoins']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['luckycoins_freeGames2']."&".$_SESSION['luckycoins_freeGames']."&".$_SESSION['luckycoins_freeGamesBank']."&".$_SESSION['double_balance'];
	...
	//$_SESSION['double_balance']=$rtnBalance;
	//$_SESSION['double_win']=$winall;
	$_SESSION['double_win'] = $_SESSION['luckycoins_freeGamesWin'];
	///////////////////////////////////////////////finish answer
	...
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_luckycoins'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['luckycoins_freeGames2']."&".$_SESSION['luckycoins_freeGames']."&".$_SESSION['luckycoins_freeGamesBank']."&".$_SESSION['double_balance'];
	...
	$dc=$_SESSION['dcard_luckycoins'];
	$userId=$user_id;
 $_SESSION['dcard_luckycoins']=$dc;
	...
	$casbank=get_bank($user_id,'luckycoins',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'luckycoins',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_luckycoins'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'luckycoins',$winall*-1,"double");	
	...
	$_SESSION['dcard_luckycoins']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_luckycoins"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_luckycoins");
	ge_serv_show_str( $rtn);	
	}
