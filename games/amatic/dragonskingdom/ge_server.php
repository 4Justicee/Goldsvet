...
$betsLength="0".$betsLength;
			...
			$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='dragonskingdom'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['dragonskingdom_freeGames2']."&".$_SESSION['dragonskingdom_freeGames']."&".$_SESSION['dragonskingdom_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['dragonskingdom_freeGames2']=$hisTmp2[4];
$_SESSION['dragonskingdom_freeGames']=$hisTmp2[5];
$_SESSION['dragonskingdom_freeGamesBank']=$hisTmp2[6];
$_SESSION['dragonskingdom_freeSym']=$hisTmp2[8];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['dragonskingdom_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['dragonskingdom_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['dragonskingdom_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_dragonskingdom']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."0014101010101010101010101015101010101010101010101010101010101010101010".$_SESSION['dcard_dragonskingdom']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_dragonskingdom");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_dragonskingdom'])){
$_SESSION['dcard_dragonskingdom']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'dragonskingdom',$allbet,"spin");
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
  if($isBonus){
 change_bank($user_id,'dragonskingdom',$winall*-1,"bonus");	
  }else{
 change_bank($user_id,'dragonskingdom',$winall*-1,"spin");	
  }
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dragonskingdom_freeGamesWin']=$winall;
	...
	$_SESSION['rmap_dragonskingdom']=$map;	
	...
	$_SESSION['dragonskingdom_freeGames']=7;
	$_SESSION['dragonskingdom_freeGames2']=7;
	
	$_SESSION['dragonskingdom_freeGamesBank']=$gset['sum'];
...
$gameState="05";	
	...
	$_SESSION['dragonskingdom_freeSym']=rand(1,3);

	$respinMap.="1".$_SESSION['dragonskingdom_freeSym'];
	
	
	/*-------------------------------*/
	
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr."1b0f24100e292c17"."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['dragonskingdom_freeGames2']."&".$_SESSION['dragonskingdom_freeGames']."&".$_SESSION['dragonskingdom_freeGamesBank']."&".$rtnBalance."&".$_SESSION['dragonskingdom_freeSym'];
	...
	$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101015".$winstr.$_SESSION['dcard_dragonskingdom'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['dragonskingdom_freeGames2']."&".$_SESSION['dragonskingdom_freeGames']."&".$_SESSION['dragonskingdom_freeGamesBank']."&".$rtnBalance."&".$_SESSION['dragonskingdom_freeSym'];
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_dragonskingdom");
...
if($_SESSION['dragonskingdom_freeSym']==2){
...
if($_SESSION['dragonskingdom_freeSym']==1){
...
if($_SESSION['dragonskingdom_freeSym']==3){
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['dragonskingdom_freeGamesBank'];
 $casbank_full=get_bank($user_id,'dragonskingdom',"bonus");
	if($_SESSION['dragonskingdom_freeGamesBank']<0){
$_SESSION['dragonskingdom_freeGamesBank']=0;
}
...
$isBonus=true;	
	...
	$_SESSION['dragonskingdom_freeGames']--;
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'dragonskingdom',$winall*-1,"bonus");	
$_SESSION['dragonskingdom_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dragonskingdom_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['dragonskingdom_freeGamesWin'];
	
	$hisWin=$_SESSION['dragonskingdom_freeGamesWin'];	
	...
	if($_SESSION['dragonskingdom_freeGames']<=0){
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['dragonskingdom_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_dragonskingdom']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['dragonskingdom_freeGames2']."&".$_SESSION['dragonskingdom_freeGames']."&".$_SESSION['dragonskingdom_freeGamesBank']."&".$rtnBalance."&".$_SESSION['dragonskingdom_freeSym'];
	...
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."101010101010101010101015".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['dragonskingdom_freeGamesWin'];
	...
	$dc=$_SESSION['dcard_dragonskingdom'];
	$userId=$user_id;
 $_SESSION['dcard_dragonskingdom']=$dc;
	...
	$casbank=get_bank($user_id,'dragonskingdom',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'dragonskingdom',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_dragonskingdom'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'dragonskingdom',$winall*-1,"double");	
	...
	$_SESSION['dcard_dragonskingdom']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_dragonskingdom"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_dragonskingdom");
	ge_serv_show_str($rtn);	
	}
