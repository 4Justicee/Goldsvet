...
$betsLength="0".$betsLength;
			...
			$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='dynamite7'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['dynamite7_freeGames2']."&".$_SESSION['dynamite7_freeGames']."&".$_SESSION['dynamite7_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['dynamite7_freeGames2']=$hisTmp2[4];
$_SESSION['dynamite7_freeGames']=$hisTmp2[5];
$_SESSION['dynamite7_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['dynamite7_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['dynamite7_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['dynamite7_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$hisWin=strlen($winall_h).$winall_h;
	...
	$rtn="".$hisState."0".$hisReel."10".$hisBalance.$hisWin."00".$minBets.$maxBets."0a".$f2.$f1."10111110100a0a0a1100".$hisReel."0000000000000000".$betsLength.$betString."0a10101010101010101010";
	echo $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_dynamite7']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."000a10101010101010101010100b1010101010101010101010".$_SESSION['dcard_dynamite7']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_dynamite7");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_dynamite7'])){
$_SESSION['dcard_dynamite7']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'dynamite7',$allbet,"spin");
...
$psym[1]=array(0,0,0,50,200,500);
$psym[2]=array(0,0,0,50,200,500);
$psym[3]=array(0,0,0,20,50,200);
$psym[4]=array(0,0,0,20,50,200);
$psym[5]=array(0,0,0,20,50,200);
$psym[6]=array(0,0,0,20,50,200);
...
$r[0]=array(4, 4, 4, 2, 2, 5, 2, 5, 5, 5, 5, 1, 0, 1, 1, 3, 3, 3, 0, 3, 3, 3, 3, 0, 3, 3, 3, 1, 1, 0, 1, 4, 4, 4, 6, 6, 6, 5, 5, 5, 5, 2, 5, 2, 2, 5, 5, 6, 6, 6, 4, 4, 4, 2, 2, 5, 2, 5, 5, 5, 5, 1, 0, 1, 1, 4, 4, 3, 3, 0, 3, 3, 3, 0, 3, 3, 4, 4, 1, 1, 0, 1, 4, 4, 4, 6, 6, 6, 5, 5, 5, 5, 2, 5, 2, 2, 6, 6, 6);
$r[1]=array(6, 6, 6, 5, 5, 5, 1, 1, 4, 1, 4, 4, 4, 3, 4, 3, 4, 3, 3, 3, 3, 5, 5, 5, 6, 0, 6, 6, 6, 4, 4, 4, 6, 6, 0, 6, 6, 6, 2, 2, 0, 2, 2, 0, 2, 2, 1, 1, 4, 1, 6, 6, 6, 5, 5, 5, 0, 5, 1, 1, 4, 1, 4, 4, 4, 3, 4, 3, 3, 3, 5, 5, 5, 0, 5, 6, 6, 6, 6, 6, 4, 4, 4, 3, 4, 3, 3, 3, 2, 2, 0, 2, 2, 0, 2, 2, 1, 1, 4, 1);
$r[2]=array(1, 3, 1, 1, 3, 1, 3, 3, 3, 3, 4, 4, 6, 4, 4, 4, 3, 3, 3, 3, 6, 3, 6, 6, 6, 6, 4, 6, 4, 4, 0, 4, 4, 4, 5, 5, 5, 6, 6, 6, 2, 6, 2, 6, 2, 2, 5, 5, 5, 0, 1, 3, 1, 1, 3, 3, 3, 0, 4, 4, 6, 4, 4, 4, 5, 0, 5, 5, 5, 3, 3, 3, 1, 3, 1, 1, 2, 6, 2, 2, 6, 6, 4, 6, 4, 0, 4, 4, 4, 5, 5, 5, 6, 6, 2, 6, 2, 2, 5, 0);
$r[3]=array(4, 4, 4, 4, 6, 4, 6, 6, 6, 6, 5, 5, 5, 5, 5, 3, 3, 3, 0, 3, 1, 1, 6, 6, 6, 6, 4, 6, 4, 4, 4, 4, 1, 1, 3, 0, 3, 3, 3, 3, 3, 2, 2, 3, 3, 5, 5, 5, 2, 2, 5, 5, 4, 4, 4, 6, 4, 6, 6, 6, 6, 5, 5, 5, 5, 5, 3, 3, 3, 0, 3, 1, 1, 6, 6, 4, 6, 4, 4, 4, 4, 1, 1, 3, 0, 3, 3, 3, 3, 3, 0, 2, 2, 5, 5, 5, 5, 5, 0, 2);
$r[4]=array(6, 6, 6, 5, 5, 0, 3, 3, 3, 3, 3, 1, 1, 2, 2, 5, 5, 5, 4, 0, 4, 4, 4, 0, 4, 3, 3, 3, 1, 1, 5, 5, 5, 2, 2, 4, 4, 4, 0, 6, 6, 6, 6, 6, 6, 5, 5, 0, 3, 3, 3, 3, 3, 1, 1, 4, 4, 4, 2, 2, 5, 5, 5, 5, 5, 3, 3, 0, 4, 6, 4, 0, 4, 3, 3, 3, 1, 1, 5, 5, 5, 2, 2, 4, 4, 4, 6, 4, 0, 6, 6, 6);	
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
	 ...
	 if($isBonus){
 change_bank($user_id,'dynamite7',$winall*-1,"bonus");	
  }else{
 change_bank($user_id,'dynamite7',$winall*-1,"spin");
  }
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dynamite7_freeGamesWin']=$winall;
	...
	$_SESSION['dynamite7_freeGames']=15;
	
	$_SESSION['dynamite7_freeGamesBank']=$gset['sum'];
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_dynamite7']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['dynamite7_freeGames2']."&".$_SESSION['dynamite7_freeGames']."&".$_SESSION['dynamite7_freeGamesBank']."&".$rtnBalance;
	...
	$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_dynamite7'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['dynamite7_freeGames2']."&".$_SESSION['dynamite7_freeGames']."&".$_SESSION['dynamite7_freeGamesBank']."&".$rtnBalance;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_dynamite7");
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['dynamite7_freeGamesBank'];
 $casbank_full=get_bank($user_id,'dynamite7',"bonus");
	if($_SESSION['dynamite7_freeGamesBank']<0){
$_SESSION['dynamite7_freeGamesBank']=0;
}
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'dynamite7',$winall*-1,"bonus");	
$_SESSION['dynamite7_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dynamite7_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['dynamite7_freeGamesWin'];
	$hisWin=$_SESSION['dynamite7_freeGamesWin'];	
	...
	if($_SESSION['dynamite7_freeGames']<=0){
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['dynamite7_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_dynamite7']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['dynamite7_freeGames2']."&".$_SESSION['dynamite7_freeGames']."&".$_SESSION['dynamite7_freeGamesBank']."&".$rtnBalance;
	...
	$dc=$_SESSION['dcard_dynamite7'];
	$userId=$user_id;
 $_SESSION['dcard_dynamite7']=$dc;
	...
	$casbank=get_bank($user_id,'dynamite7',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'dynamite7',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_dynamite7'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'dynamite7',$winall*-1,"double");	
	...
	$_SESSION['dcard_dynamite7']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_dynamite7"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_dynamite7");
	ge_serv_show_str($rtn);	
	}
