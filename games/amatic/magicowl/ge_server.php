...
$betsLength="0".$betsLength;
	...
	$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='magicowl'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['magicowl_freeGames2']."&".$_SESSION['magicowl_freeGames']."&".$_SESSION['magicowl_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['magicowl_freeGames2']=$hisTmp2[4];
$_SESSION['magicowl_freeGames']=$hisTmp2[5];
$_SESSION['magicowl_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['magicowl_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['magicowl_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['magicowl_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$hisWin=strlen($winall_h).$winall_h;
	...
	$rtn="".$hisState."0".$hisReel."10".$hisBalance.$hisWin."00".$minBets.$maxBets."32".$f2.$f1."101111101032320a1100".$hisReel."0000000000000000".$betsLength.$betString."33101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010";
	echo $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_magicowl']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."0032101010101010101010101033101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010".$_SESSION['dcard_magicowl']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_magicowl");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_magicowl'])){
$_SESSION['dcard_magicowl']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'magicowl',$allbet,"spin");
...
$psym[0]=array(0,0,0,50,200,500);
$psym[1]=array(0,0,0,25,100,250);
$psym[2]=array(0,0,0,20,50,150);
$psym[3]=array(0,0,0,15,30,100);
$psym[4]=array(0,0,0,15,30,100);
$psym[5]=array(0,0,0,10,20,75);
$psym[6]=array(0,0,0,10,20,75);
$psym[7]=array(0,0,0,5,10,50);
$psym[8]=array(0,0,0,5,10,50);
$psym[9]=array(0,0,0,2,2,2);
	//////////////////////////////////////////////////loop
...
$r[0]=array(1, 1, 1, 1, 6, 2, 2, 2, 2, 6, 6, 6, 6, 1, 1, 1, 1, 5, 4, 4, 4, 4, 9, 5, 5, 5, 5, 0, 0, 0, 0, 8, 7, 3, 3, 3, 3, 7, 7, 7, 7, 8, 8, 8, 8);
$r[1]=array(0, 0, 0, 0, 6, 6, 6, 6, 3, 3, 3, 7, 6, 3, 0, 0, 0, 0, 5, 5, 5, 5, 2, 2, 2, 2, 7, 7, 7, 7, 1, 1, 1, 1, 8, 8, 8, 8, 1, 1, 1, 1, 4, 4, 4, 4, 5, 8);
$r[2]=array(1, 1, 1, 1, 3, 3, 3, 3, 5, 9, 8, 1, 1, 1, 1, 4, 4, 4, 4, 6, 6, 6, 7, 7, 7, 7, 9, 8, 8, 8, 8, 0, 0, 0, 0, 2, 2, 2, 2, 5, 5, 5, 5, 6, 6, 7, 9, 6, 7, 8, 6);
$r[3]=array(0, 0, 0, 0, 6, 7, 7, 8, 0, 0, 0, 0, 2, 2, 2, 2, 3, 3, 3, 3, 5, 5, 5, 8, 8, 1, 1, 1, 1, 4, 4, 4, 4, 6, 6, 6, 6, 7, 7, 7, 8, 8, 5, 5, 1, 1, 1, 1);
$r[4]=array(1, 1, 1, 1, 5, 5, 5, 9, 8, 8, 8, 8, 1, 1, 1, 1, 7, 7, 7, 9, 6, 6, 6, 4, 4, 4, 4, 7, 7, 9, 6, 6, 0, 0, 0, 0, 3, 3, 3, 3, 5, 5, 2, 2, 2, 2, 8, 8);	
...
if($winall>0){
 ...
 change_bank($user_id,'magicowl',$winall*-1,"spin");	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['magicowl_freeGamesWin']=$winall;
	...
	$_SESSION['magicowl_freeGames']=5;
	$_SESSION['magicowl_freeGames2']=5;
	$_SESSION['magicowl_freeGamesBank']=$gset['sum'];
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_magicowl']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['magicowl_freeGames2']."&".$_SESSION['magicowl_freeGames']."&".$_SESSION['magicowl_freeGamesBank']."&".$rtnBalance;
	...
	///////////////////////////////balance
		...
		$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101033".$winstr.$_SESSION['dcard_magicowl']."f15fffff15fffff15fffff15fffff"."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['magicowl_freeGames2']."&".$_SESSION['magicowl_freeGames']."&".$_SESSION['magicowl_freeGamesBank']."&".$rtnBalance;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_magicowl");
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'magicowl',$winall*-1,"spin");	
$_SESSION['magicowl_freeGamesBank']-=	$winall;	
$_SESSION['magicowl_freeGamesWin']+=$winall;	
}	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	//$winall_r=$_SESSION['magicowl_freeGamesWin'];
	...
	$_SESSION['magicowl_freeGames']--;
	
	
	$gameState="06";
    
	if($_SESSION['magicowl_freeGames']<=0){
...
$ww="1f";	
	...
	/*-------------------------------*/
	$winall2=($_SESSION['magicowl_freeGamesWin']*$conf['fmp']);
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_magicowl']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['magicowl_freeGames2']."&".$_SESSION['magicowl_freeGames']."&".$_SESSION['magicowl_freeGamesBank']."&".$rtnBalance;
	...
	//$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."101010101010101010101033".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['magicowl_freeGamesWin'];
	...
	$dc=$_SESSION['dcard_magicowl'];
	$userId=$user_id;
 $_SESSION['dcard_magicowl']=$dc;
	...
	$casbank=get_bank($user_id,'magicowl',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'magicowl',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_magicowl'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'magicowl',$winall*-1,"double");	
	...
	$_SESSION['dcard_magicowl']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_magicowl"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_magicowl");
	ge_serv_show_str( $rtn);	
	}
