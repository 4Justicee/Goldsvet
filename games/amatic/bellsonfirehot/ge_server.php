...
$minBets.=strlen(dechex($betsArr[0]*$conf['fmp'])).dechex($betsArr[0]*$conf['fmp']);	
...
$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='bellsonfirehot'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['bellsonfirehot_freeGames2']."&".$_SESSION['bellsonfirehot_freeGames']."&".$_SESSION['bellsonfirehot_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['bellsonfirehot_freeGames2']=$hisTmp2[4];
$_SESSION['bellsonfirehot_freeGames']=$hisTmp2[5];
$_SESSION['bellsonfirehot_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['bellsonfirehot_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['bellsonfirehot_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['bellsonfirehot_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$rtn="100010".$rtnBalance."10".$rtnReels."00641010101010101010101010651010101010101010101010".$_SESSION['dcard_bellsonfirehot']."f15fffff15fffff15fffff15fffff";
...
if($winall>0){
 ...
 if($isBonus){
 change_bank($user_id,'bellsonfirehot',$winall*-1,"bonus");	
 }else{
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['bellsonfirehot_freeGames2']=15;
...
$gameState="05";	
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_bellsonfirehot']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['bellsonfirehot_freeGames2']."&".$_SESSION['bellsonfirehot_freeGames']."&".$_SESSION['bellsonfirehot_freeGamesBank']."&".$_SESSION['double_balance'];
	...
	///////////////////////////////balance
		...
		$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."101010101010101010101065".$winstr.$_SESSION['dcard_bellsonfirehot'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['bellsonfirehot_freeGames2']."&".$_SESSION['bellsonfirehot_freeGames']."&".$_SESSION['bellsonfirehot_freeGamesBank']."&".$_SESSION['double_balance'];
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank_full=get_bank($user_id,'bellsonfirehot',"bonus");	
		if($_SESSION['bellsonfirehot_freeGamesBank']<0){
			$_SESSION['bellsonfirehot_freeGamesBank']=0;
		}
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$hisWin=$_SESSION['bellsonfirehot_freeGamesWin'];
...
$_SESSION['bellsonfirehot_freeGames']+=15;	
	...
	$freeR2=dechex(strlen($freeRH2)).$freeRH2;
	 ...
	 $freeInfo=$freeR2.$freeR.$ww."131010".$rtnReels."65";	
	/*-------------------------------*/
	$winall2=$_SESSION['bellsonfirehot_freeGamesWin']*$conf['fmp'];
	...
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."101010101010101010101065".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['bellsonfirehot_freeGamesWin'];
