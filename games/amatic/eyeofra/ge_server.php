...
$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='eyeofra'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['eyeofra_freeGames2']."&".$_SESSION['eyeofra_freeGames']."&".$_SESSION['eyeofra_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
//$hisBalance=$hisTmp2[7];
$_SESSION['eyeofra_freeGames2']=$hisTmp2[4];
$_SESSION['eyeofra_freeGames']=$hisTmp2[5];
$_SESSION['eyeofra_freeGamesBank']=$hisTmp2[6];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['eyeofra_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['eyeofra_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['eyeofra_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$hisWin=strlen($winall_h).$winall_h;
	...
	$rtn="".$hisState."0".$hisReel."10".$hisBalance.$hisWin."00".$minBets.$maxBets."0b".$f2.$f1."10101010100b0b0b1100".$hisReel."000000000000000013".$betString."0c101010101010101010101010";
	return $rtn;   
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_eyeofra']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."000b10101010101010101010100c1010101010101010101010".$_SESSION['dcard_eyeofra']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_eyeofra");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_eyeofra'])){
$_SESSION['dcard_eyeofra']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'eyeofra',$allbet,"spin");
...
$psym[10]=array(0,0,0,1,2,5);
$psym[11]=array(0,0,0,2,10,50);
...
$r[0]=array(9, 9, 0, 7, 7, 2, 10, 10, 10, 3, 8, 6, 1, 4, 5, 9, 9, 9, 11, 8, 8, 2, 7, 7, 3, 8, 4, 10, 10, 5, 8, 8, 8, 8, 6);
$r[1]=array(9, 9, 3, 3, 10, 11, 7, 7, 5, 5, 10, 6, 7, 7, 0, 9, 6, 10, 10, 3, 3, 5, 2, 1, 9, 9, 4, 5, 7, 8, 12, 12, 12, 12, 6, 10, 10, 3, 5, 9, 9, 10, 10, 10, 10, 9, 7, 6, 6);
$r[2]=array(2, 10, 4, 9, 5, 5, 5, 8, 8, 7, 7, 0, 9, 3, 7, 4, 4, 8, 10, 9, 11, 10, 9, 6, 6, 7, 4, 10, 10, 1, 8, 8, 8, 2, 2, 9, 6, 6, 7, 7, 9, 10, 12, 12, 12, 12, 12, 6, 6, 0, 9, 10, 10, 6, 8, 8, 5, 7, 7, 9, 9, 9);
$r[3]=array(9, 3, 8, 4, 10, 10, 5, 6, 0, 7, 7, 2, 8, 8, 3, 7, 7, 5, 11, 9, 4, 9, 9, 3, 10, 1, 8, 8, 4, 7, 5, 10, 9, 2, 10, 10, 5, 7, 8, 4, 9, 12, 12, 12, 12, 9, 9, 2, 10, 10, 6, 6, 6);
$r[4]=array(9, 9, 0, 2, 8, 5, 7, 7, 3, 6, 6, 8, 4, 4, 10, 10, 5, 11, 8, 1, 10, 6, 6, 2, 0, 7, 7, 1, 3, 9, 9, 0, 5, 8, 4, 6, 10, 10, 3, 7, 4, 6, 6, 5, 8, 2, 9, 1, 1, 1);	
...
if($scatter_win>=3){	
$winall+=($psym[11][$scatter_win]*$gBet*10);
$winall_r+=($psym[11][$scatter_win]*10);
...
if($winall>0){
 ...
 change_bank($user_id,'eyeofra',$winall*-1,"spin");	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['eyeofra_freeGamesWin']=$winall;
	...
	$_SESSION['rmap_eyeofra']=$map;	
	
	
	$gameState="03";
    $freeInfo="10101010101010101010100c";
	if($isBonus && $scatter_win>=3){
	$hisState="freegame_start";
	$_SESSION['eyeofra_freeGames']=5;
	$_SESSION['eyeofra_freeGames2']=5;
	
	$_SESSION['eyeofra_freeGamesBank']=$gset['sum'];
	
$gameState="05";	
	 $freeInfo="15151011101010101010100c";	
	}
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_eyeofra']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['eyeofra_freeGames2']."&".$_SESSION['eyeofra_freeGames']."&".$_SESSION['eyeofra_freeGamesBank']."&".$rtnBalance;
	
	
	
	//////////////////////////////////////////////double_answer
	
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."10101010101010101010100c".$winstr."";
	...
	$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100c".$winstr.$_SESSION['dcard_eyeofra'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['eyeofra_freeGames2']."&".$_SESSION['eyeofra_freeGames']."&".$_SESSION['eyeofra_freeGamesBank']."&".$rtnBalance;
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_eyeofra");
...
if(!isset($_SESSION['dcard_eyeofra'])){
$_SESSION['dcard_eyeofra']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
...
$r[0]=array(9, 9, 0, 7, 7, 2, 10, 10, 10, 3, 8, 6, 1, 4, 5, 9, 9, 9, 11, 8, 8, 2, 7, 7, 3, 8, 4, 10, 10, 5, 8, 8, 8, 8, 6);
$r[1]=array(9, 9, 3, 3, 10, 11, 7, 7, 5, 5, 10, 6, 7, 7, 0, 9, 6, 10, 10, 3, 3, 5, 2, 1, 9, 9, 4, 5, 7, 8, 12, 12, 12, 12, 6, 10, 10, 3, 5, 9, 9, 10, 10, 10, 10, 9, 7, 6, 6);
$r[2]=array(12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12);
$r[3]=array(9, 3, 8, 4, 10, 10, 5, 6, 0, 7, 7, 2, 8, 8, 3, 7, 7, 5, 11, 9, 4, 9, 9, 3, 10, 1, 8, 8, 4, 7, 5, 10, 9, 2, 10, 10, 5, 7, 8, 4, 9, 12, 12, 12, 12, 9, 9, 2, 10, 10, 6, 6, 6);
$r[4]=array(9, 9, 0, 2, 8, 5, 7, 7, 3, 6, 6, 8, 4, 4, 10, 10, 5, 11, 8, 1, 10, 6, 6, 2, 0, 7, 7, 1, 3, 9, 9, 0, 5, 8, 4, 6, 10, 10, 3, 7, 4, 6, 6, 5, 8, 2, 9, 1, 1, 1);	
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['eyeofra_freeGamesBank']; 
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'eyeofra',$winall*-1,"spin");	
$_SESSION['eyeofra_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['eyeofra_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['eyeofra_freeGamesWin'];
	$hisWin=$_SESSION['eyeofra_freeGamesWin'];
	...
	if($_SESSION['eyeofra_freeGames']<=0){
...
$ww="19";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['eyeofra_freeGamesWin']*$conf['fmp'];
	...
	$rtn="1".$gameState."0"."10".$_SESSION['double_balance'].strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_eyeofra']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['eyeofra_freeGames2']."&".$_SESSION['eyeofra_freeGames']."&".$_SESSION['eyeofra_freeGamesBank']."&".$rtnBalance;
	...
	//$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."10101010101010101010100c".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['eyeofra_freeGamesWin'];
	...
	$dc=$_SESSION['dcard_eyeofra'];
	$userId=$user_id;
 $_SESSION['dcard_eyeofra']=$dc;
	...
	$casbank=get_bank($user_id,'eyeofra',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'eyeofra',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_eyeofra'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'eyeofra',$winall*-1,"double");	
	...
	$_SESSION['dcard_eyeofra']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_eyeofra"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_eyeofra");
	ge_serv_show_str( $rtn);	
	}
