...
$res1=mysql_fetch_assoc(mysql_query("SELECT g_id FROM game_settings WHERE room_id='$room' AND  g_name='bookofaztec'"));
...
//&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['bookofaztec_freeGames2']."&".$_SESSION['bookofaztec_freeGames']."&".$_SESSION['bookofaztec_freeGamesBank']
...
$hisReel=$hisTmp2[2];	
////$hisBalance=$hisTmp2[7];
$_SESSION['bookofaztec_freeGames2']=$hisTmp2[4];
$_SESSION['bookofaztec_freeGames']=$hisTmp2[5];
$_SESSION['bookofaztec_freeGamesBank']=$hisTmp2[6];
$_SESSION['bookofaztec_freeSym']=$hisTmp2[8];
$_SESSION['double_balance']=$hisBalance;

$freeRH=dechex($_SESSION['bookofaztec_freeGames']);
	$freeR=dechex(strlen($freeRH)).$freeRH;
	$freeRH2=dechex($_SESSION['bookofaztec_freeGames2']);
...
$str_winall=str_replace(".","",$hisTmp2[1]."");
$_SESSION['bookofaztec_freeGamesWin']=$onlyWin;	
$_SESSION['double_win']=$onlyWin;	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['dcard_bookofaztec']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."";
	
	
	$rtn="100010".$rtnBalance."10".$rtnReels."000a10101010101010101010100b1010101010101010101010".$_SESSION['dcard_bookofaztec']."f15fffff15fffff15fffff15fffff";
	 set_stat_game($userId, $user_balance, 0,0,"state_bookofaztec");
	return $rtn;	
	}
...
if(!isset($_SESSION['dcard_bookofaztec'])){
$_SESSION['dcard_bookofaztec']=rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5).rand(0,5)."0";
	...
	///////////////////////////////
	 ...
	 change_bank($user_id,'bookofaztec',$allbet,"spin");
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
  if($isBonus){
 change_bank($user_id,'bookofaztec',$winall*-1,"bonus");	
  }else{
 change_bank($user_id,'bookofaztec',$winall*-1,"spin");	
  }
$hisState="gamble";	
}	
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['bookofaztec_freeGamesWin']=$winall;
	...
	$_SESSION['bookofaztec_freeGames']=10;
	$_SESSION['bookofaztec_freeGames2']=10;
	$_SESSION['bookofaztec_freeSym']=rand(0,8);
	$hisState="freegame_start";
	$_SESSION['bookofaztec_freeGamesBank']=$gset['sum'];
	$respinMap="1".$_SESSION['bookofaztec_freeSym']."1010";
$gameState="05";	
	 $freeInfo="1a1a".strlen($winall_h).$winall_h."1111".strlen($winall_h).$winall_h."10101010100b";
$_SESSION['dcard_bookofaztec']="0000000000000000";	 
	}
	...
	$rtn="1".$gameState."0"."10".$rtnBalance.strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h.$freeInfo.$winstr.$_SESSION['dcard_bookofaztec']."".$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['bookofaztec_freeGames2']."&".$_SESSION['bookofaztec_freeGames']."&".$_SESSION['bookofaztec_freeGamesBank']."&".$rtnBalance."&".$_SESSION['bookofaztec_freeSym'];
	...
	$hisState="collect";
	$_SESSION['finish_answer']=strlen($winall_h).$winall_h.$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr.$_SESSION['dcard_bookofaztec'].$respinMap."#&st=".$hisState."&".$hisWin."&".$rtnReels."&".$bet_h."&".$_SESSION['bookofaztec_freeGames2']."&".$_SESSION['bookofaztec_freeGames']."&".$_SESSION['bookofaztec_freeGamesBank']."&".$rtnBalance."&".$_SESSION['bookofaztec_freeSym'];
	
	set_stat_game($userId, $user_balance, $allbet,$winall,"spin_bookofaztec");
...
//////////////////
	...
	/////////////////////////////////////game_setting
		...
		$casbank = $_SESSION['bookofaztec_freeGamesBank'];
 $casbank_full=get_bank($user_id,'bookofaztec',"bonus");
	if($_SESSION['bookofaztec_freeGamesBank']<0){
$_SESSION['bookofaztec_freeGamesBank']=0;
}
...
$isBonus=true;	
	...
	$_SESSION['bookofaztec_freeGames']--;
...
if($map[$i]==$_SESSION['bookofaztec_freeSym']){
$scatter_win2++;	
}
...
$winall+=($psym[$_SESSION['bookofaztec_freeSym']][$scatter_win2]*$gBet*$lines)*1;

	
	$expWin=($psym[$_SESSION['bookofaztec_freeSym']][$scatter_win2]*$gBet*$lines)*1;
...
if($winall>0){
 ...
 cange_balance($userId, $winall);
 change_bank($user_id,'bookofaztec',$winall*-1,"bonus");	
$_SESSION['bookofaztec_freeGamesBank']-=	$winall;
...
$rtnReels.=strlen($rHex).$rHex;		
	...
	$_SESSION['bookofaztec_freeGamesWin']+=$winall;
	//$winall_r=$_SESSION['bookofaztec_freeGamesWin'];
	$hisWin=$_SESSION['bookofaztec_freeGamesWin'];
	...
	if($_SESSION['bookofaztec_freeGames']<=0){
...
$expWinHex2=strlen($expWinHex).$expWinHex;		
	...
	$respinMap="1".$_SESSION['bookofaztec_freeSym']."1".$scatter_win2.$expWinHex2;
	$ww="10";
...
$gameState="0a";	
	...
	/*-------------------------------*/
	$winall2=$_SESSION['bookofaztec_freeGamesWin']*$conf['fmp'];
	...
	$_SESSION['double_answer']=$rtnReels."".$bet_h.$ln_h."10101010101010101010100b".$winstr."";
	//$_SESSION['double_balance']=$rtnBalance;
	$_SESSION['double_win']=$_SESSION['bookofaztec_freeGamesWin'];
...
ge_serv_show_str($rtn);		
	...
	$dc=$_SESSION['dcard_bookofaztec'];
	$userId=$user_id;
 $_SESSION['dcard_bookofaztec']=$dc;
	...
	$casbank=get_bank($user_id,'bookofaztec',"double");	
	$winall=$_SESSION['double_win'];
	$dbet=$winall;
	
	if($winall>0){
	 cange_balance($userId, $winall*-1);
	 change_bank($user_id,'bookofaztec',$winall,"double");	
...
$winall=sprintf( "%01.2f", $winall );$winall=floor_format_($winall);
	...
	$doubleCards=$_SESSION['dcard_bookofaztec'];
...
//bubi->chervy->tref->piki->
	...
	if($winall>0){
	 cange_balance($userId, $winall);
	 change_bank($user_id,'bookofaztec',$winall*-1,"double");	
	...
	$_SESSION['dcard_bookofaztec']=$doubleCards;
	$_SESSION['double_win']=$winall;
	
	
	set_stat_game($userId, $user_balance, $dbet,$winall,"double_bookofaztec"); 
...
/*----------------------------*/	
	...
	$_SESSION['double_win']=$winall;
	set_stat_game($userId, $user_balance, $winall,$winall,"double_half_bookofaztec");
	return $rtn;	
	}
