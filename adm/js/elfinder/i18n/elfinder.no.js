...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.no = {
		...
		messages   : {
			...
			'errJqui'              : 'Ugyldig jQuery UI konfigurasjon. Selectable, draggable og droppable komponentene m   v  re inkludert.',
			'errNode'              : 'elFinder p  krever at DOM Elementer kan opprettes.',
			...
			'errCmdReq'            : 'Backend sp  rringen p  krever kommando.',
			...
			'errLocked'            : '"$1" er l  st og kan ikke flyttes, slettes eller endres',
			...
			'errTrgFolderNotFound' : 'M  lmappen "$1" ble ikke funnet.',
			...
			'errMaxSize'           : 'Innholdet overg  r maksimum tillatt st  rrelse.',
			'errFileMaxSize'       : 'Filen verg  r maksimum tillatt st  rrelse.',
			'errUploadMime'        : 'Filtypen ikke tillatt.',
			'errUploadTransfer'    : '"$1" overf  rings feil.', 
			...
			'errArcType'           : 'akriv-typen er ikke st  ttet.',
			'errNoArchive'         : 'Filen er ikke et arkiv eller et arkiv som ikke er st  ttet.',
			'errCmdNoSupport'      : 'Backend st  tter ikke denne kommandoen.',
			...
			'ntfprepare'  : 'Gj  r klar til kopiering av filer',
			...
			/********************************** messages **********************************/
			'confirmReq'      : 'Bekreftelse n  dvendig',
