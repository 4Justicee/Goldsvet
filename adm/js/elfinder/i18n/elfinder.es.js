/**
 * Spanish translation
 * @author Juli  n Torres <julian.torres@pabernosmatao.com>
 * @version 2011-08-25
 */
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.es = {
		translator : 'Juli  n Torres &lt;julian.torres@pabernosmatao.com&gt;',
		language   : 'Espa  ol internacional',
		direction  : 'ltr',
		messages   : {
			...
			'errJqui'              : 'Configuraci  n no v  lida de jQuery UI. deben estar incluidos los componentes selectable, draggable y droppable.',
			'errNode'              : 'elFinder necesita crear elementos DOM.',
			'errURL'               : 'Configuraci  n no v  lida de elFinder! La opci  n URL no est   configurada.',
			'errAccess'            : 'Acceso denegado.',
			'errConnect'           : 'No se ha podido conectar con el backend.',
			'errAbort'             : 'Conexi  n cancelada.',
			'errTimeout'           : 'Conexi  n cancelada por timeout.',
			'errNotFound'          : 'Backend no encontrado.',
			'errResponse'          : 'Respuesta no v  lida del backend.',
			'errConf'              : 'Configuraci  n no v  lida del backend .',
			'errJSON'              : 'El m  dulo PHP JSON no est   instalado.',
			'errNoVolumes'         : 'No hay disponibles vol  menes legibles.',
			'errCmdParams'         : 'Par  metros no v  lidos para el comando "$1".',
			'errDataNotJSON'       : 'los datos no est  an en formato JSON.',
			'errDataEmpty'         : 'No hay datos.',
			'errCmdReq'            : 'La petici  n del backend necesita un nombre de comando.',
			...
			'errInvName'           : 'Nombre de archivo no v  lido.',
			...
			'errUploadCommon'      : 'Error en el env  io.',
			'errUpload'            : 'No se puede subir "$1".',
			'errUploadNoFiles'     : 'No hay archivos para subir.',
			'errMaxSize'           : 'El tama  o de los datos excede el m  ximo permitido.',
			'errFileMaxSize'       : 'El tama  o del archivo excede el m  ximo permitido.',
			...
			'errArcMaxSize'        : 'El tama  o del archivo excede el m  ximo permitido.',
      ...
      'ntfloadimg'  : 'Cargando imagen',
			...
			/********************************** messages **********************************/
			'confirmReq'      : 'Se necesita confirmaci  n',
			'confirmRm'       : '  Est   seguro de querer eliminar archivos?<br/>Esto no tiene vuelta atr  s!',
			'confirmRepl'     : '  Reemplazar el antig  o archivo con el nuevo?',
			...
			'no'              : 'no',
			'link'            : 'Enlace',
			'searcresult'     : 'Resultados de la b  squeda',  
			...
			'ver'             : 'Version',
			'protocol'        : 'versi  n del protocolo',
			'homepage'        : 'Project home',
			'docs'            : 'Documentaci  n',
			'github'          : 'Fork us on Github',
			'twitter'         : 'S  guenos en Twitter',
			'facebook'        : '  nete a nostros en Facebook',
			'team'            : 'Equipo',
			...
			'rmFromPlaces'    : 'Eliminar en sus ubicaci  nes',
			'untitled folder' : 'carpeta sin t  tulo',
			'untitled archivo.txt' : 'archivo.txt sin t  tulo',
      'mode'            : 'Modo',
      ...
      'crop'            : 'Recortar',
			...
			'kindMsPP'        : 'Presentaci  n Microsoft Powerpoint',
			'kindOO'          : 'Documento Open Office',
			'kindAppFlash'    : 'Aplicaci  n Flash',
			...
			'kindJS'          : 'C  digo Javascript',
			'kindRTF'         : 'Documento RTF',
			'kindC'           : 'C source',
			'kindCHeader'     : 'C  digo C header',
			'kindCPP'         : 'C  digo C++',
			'kindCPPHeader'   : 'C  digo C++ header',
			'kindShell'       : 'Script Unix shell',
			'kindPython'      : 'C  digo Python',
			'kindJava'        : 'C  digo Java',
			'kindRuby'        : 'C  digo Ruby',
			'kindPerl'        : 'C  digo Perl',
			'kindSQL'         : 'SC  digo QL',
			'kindXML'         : 'Documento XML',
			'kindAWK'         : 'C  digo AWK source',
			...
			'kindVideoDV'     : 'Pel  cula DV',
			'kindVideoMPEG'   : 'Pel  cula MPEG',
			'kindVideoMPEG4'  : 'Pel  cula MPEG-4',
			'kindVideoAVI'    : 'Pel  cula AVI',
			'kindVideoMOV'    : 'Pel  cula Quick Time',
			'kindVideoWM'     : 'Pel  cula Windows Media',
			'kindVideoFlash'  : 'Pel  cula Flash',
			'kindVideoMKV'    : 'Pel  cula Matroska MKV',
			'kindVideoOGG'    : 'Pel  cula Ogg'
		}
	}
}
