    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"groupRequired": {
                    "regex": "none",
                    "alertText": "* Az al  bbi mez  k valamelyik  t ki kell t  lteni"
                },
                "min": {
                    "regex": "none",
                ...
                "equals": {
                    "regex": "none",
                    "alertText": "* A mez  k nem egyeznek"
                },
                "creditCard": {
                    "regex": "none",
                ...
                "phone": {
                    ...
                    "regex": /^([\+][0-9]{1,3}[\ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9\ \.\-\/]{3,20})((m|mell|mell  k)[\ ]?[0-9]{1,4})?$/,
