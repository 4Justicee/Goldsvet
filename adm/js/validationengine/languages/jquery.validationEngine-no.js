        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "* Dette feltet er p  krevd",
                    "alertTextCheckboxMultiple": "* Velg et alternativ",
                    "alertTextCheckboxe": "* Denne boksen er p  krevd",
                    "alertTextDateRange": "* Begge datofelt m   fylles ut"
                },
                "requiredInFunction": { 
                    "func": function(field, rules, i, options){
                        return (field.val() == "test") ? true : false;
                    },
                    "alertText": "* Feltet m   v  re lik test"
                },
                "dateRange": {
                    "regex": "none",
                    "alertText": "* Ugyldig ",
				...
				"groupRequired": {
                    "regex": "none",
                    "alertText": "* Du m   fylle ett av de f  lgende feltene"
                },
                "min": {
                    "regex": "none",
			...
			"func": function (field) {
			 ...
			 "alertText": "* Ugyldig dato, m   v  re i formatet         -MM-DD"
                },
                "ipv4": {
				...
				"dateTimeFormat": {
                    ...
                    "alertText3": "mm/dd/         tt:mm:ss AM|PM or ", 
                    "alertText4": "        -mm-dd tt:mm:ss AM|PM"
	            }
            };
