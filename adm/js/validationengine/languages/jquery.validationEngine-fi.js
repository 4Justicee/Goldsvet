    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "min": {
                    "regex": "none",
                    "alertText": "* V  hitt  isluku on "
                },
                "max": {
                    "regex": "none",
                    "alertText": "* Enimm  isluku on "
                },
                "past": {
                    "regex": "none",
                    "alertText": "* P  iv  m    r   ennen "
                },
                "future": {
                    "regex": "none",
                    "alertText": "* P  iv  m    r   j  lkeen "
                },	
                "maxCheckbox": {
                    "regex": "none",
                    "alertText": "* Enint    n ",
                ...
                "email": {
                    ...
                    "alertText": "* Viallinen s  hk  postiosoite"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                ...
                "date": {
                    ...
                    "alertText": "* Viallinen p  iv  m    r  . P  iv  m    r  n  t  ytyy olla VVVV-KK-PP muodossa"
                },
                "ipv4": {
                ...
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
                    "alertText": "* Erikoismerkit eiv  t ole sallittuja"
                }
            };
